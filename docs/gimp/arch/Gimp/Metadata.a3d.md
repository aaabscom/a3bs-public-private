...
<a name="get-methods"></a>
  - ⚠️ **get_colorspace** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'get_colorspace'_<br>
  - ⚠️ **get_data** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'get_data'_<br>
  - ⚠️ **get_guid** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'get_guid'_<br>
...
<a name="is-methods"></a>
  ...
  - ⚠️ **is_tag_supported** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'is_tag_supported'_<br>
- #### 🔹 notify Methods
...
<a name="set-methods"></a>
  - ⚠️ **set_bits_per_sample** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'set_bits_per_sample'_<br>
  - ⚠️ **set_colorspace** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'set_colorspace'_<br>
  - ⚠️ **set_creation_date** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'set_creation_date'_<br>
  - ⚠️ **set_data** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'set_data'_<br>
  - ⚠️ **set_from_exif** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'set_from_exif'_<br>
  - ⚠️ **set_from_iptc** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'set_from_iptc'_<br>
  - ⚠️ **set_from_xmp** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'set_from_xmp'_<br>
  - ⚠️ **set_pixel_size** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'set_pixel_size'_<br>
...
<a name="ungrouped-methods"></a>
  - ⚠️ **add_xmp_history** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'add_xmp_history'_<br>
  ...
  - ⚠️ **load_from_file** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'load_from_file'_<br>

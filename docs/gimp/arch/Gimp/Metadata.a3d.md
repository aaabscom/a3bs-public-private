...
⚠️ **get_colorspace** _Unavailable_ †<br>
⚠️ **get_data** _Unavailable_ †<br>
⚠️ **get_guid** _Unavailable_ †<br>
...
⚠️ **is_tag_supported** _Unavailable_ †<br>
- #### 🔹 notify Methods
...
⚠️ **set_bits_per_sample** _Unavailable_ †<br>
⚠️ **set_colorspace** _Unavailable_ †<br>
⚠️ **set_creation_date** _Unavailable_ †<br>
⚠️ **set_data** _Unavailable_ †<br>
⚠️ **set_from_exif** _Unavailable_ †<br>
⚠️ **set_from_iptc** _Unavailable_ †<br>
⚠️ **set_from_xmp** _Unavailable_ †<br>
⚠️ **set_pixel_size** _Unavailable_ †<br>
...
⚠️ **add_xmp_history** _Unavailable_ †<br>
...
⚠️ **load_from_file** _Unavailable_ †<br>

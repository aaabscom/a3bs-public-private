...
⚠️ **get_colorspace** _Unavailable_ †
⚠️ **get_data** _Unavailable_ †
⚠️ **get_guid** _Unavailable_ †
...
⚠️ **is_tag_supported** _Unavailable_ †
- #### 🔹 notify Methods
...
⚠️ **set_bits_per_sample** _Unavailable_ †
⚠️ **set_colorspace** _Unavailable_ †
⚠️ **set_creation_date** _Unavailable_ †
⚠️ **set_data** _Unavailable_ †
⚠️ **set_from_exif** _Unavailable_ †
⚠️ **set_from_iptc** _Unavailable_ †
⚠️ **set_from_xmp** _Unavailable_ †
⚠️ **set_pixel_size** _Unavailable_ †
...
⚠️ **add_xmp_history** _Unavailable_ †
...
⚠️ **load_from_file** _Unavailable_ †
⚠️ **new** _Unavailable_ †

...
---
title: "ModuleDB Class Documentation"
date: 2025-06-27
layout: default
---

## Table of Contents
- [🔧 Class:ModuleDB](#class-moduledb)
...
<a name="get-methods"></a>
  ...
  - ⚠️ **get_item** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'get_item'_<br>
  - ⚠️ **get_item_type** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'get_item_type'_<br>
  - ⚠️ **get_load_inhibit** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'get_load_inhibit'_<br>
  - ⚠️ **get_n_items** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'get_n_items'_<br>
  ...
  - ⚠️ **get_verbose** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'get_verbose'_<br>
- #### 🔹 handler Methods
...
<a name="set-methods"></a>
  ...
  - ⚠️ **set_load_inhibit** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'set_load_inhibit'_<br>
  ...
  - ⚠️ **set_verbose** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'set_verbose'_<br>
- #### 🔹 steal Methods
...
<a name="ungrouped-methods"></a>
  ...
  - ⚠️ **items_changed** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'items_changed'_<br>
  ...
  - ⚠️ **refresh** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'refresh'_<br>

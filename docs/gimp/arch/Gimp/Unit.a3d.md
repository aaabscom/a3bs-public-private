...
---
title: "Unit Class Documentation"
date: 2025-06-27
layout: default
---
...
<a name="get-methods"></a>
  - ⚠️ **get_abbreviation** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'get_abbreviation'_<br>
  ...
  - ⚠️ **get_deletion_flag** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'get_deletion_flag'_<br>
  - ⚠️ **get_digits** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'get_digits'_<br>
  - ⚠️ **get_factor** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'get_factor'_<br>
  ...
  - ⚠️ **get_scaled_digits** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'get_scaled_digits'_<br>
  - ⚠️ **get_symbol** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'get_symbol'_<br>
- #### 🔹 handler Methods
...
- #### 🔹 is Methods
<a name="is-methods"></a>
  - ⚠️ **is_built_in** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'is_built_in'_<br>
  - ⚠️ **is_floating** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'is_floating'_<br>
  - ⚠️ **is_metric** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'is_metric'_<br>
- #### 🔹 notify Methods
...
<a name="set-methods"></a>
  ...
  - ⚠️ **set_deletion_flag** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'set_deletion_flag'_<br>
...
<a name="ungrouped-methods"></a>
  ...
  - ⚠️ **format_string** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'format_string'_<br>
  ...
  - ⚠️ **inch** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'inch'_<br>
  - ⚠️ **list_properties** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'list_properties'_<br>
  - ⚠️ **mm** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'mm'_<br>
  ...
  - ⚠️ **percent** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'percent'_<br>
  - ⚠️ **pica** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'pica'_<br>
  - ⚠️ **pixel** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'pixel'_<br>
  - ⚠️ **point** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'point'_<br>
...
<a name="properties-"></a>
  ...
  - **symbol**: `gchararray` (read/write)
  - **abbreviation**: `gchararray` (read/write)
<br>
#### 📣 Signals
<a name="signals-"></a>
<br>- None found

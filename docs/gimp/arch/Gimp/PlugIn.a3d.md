...
<a name="add-methods"></a>
  - ⚠️ **add_menu_branch** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'add_menu_branch'_<br>
  - ⚠️ **add_temp_procedure** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'add_temp_procedure'_<br>
- #### 🔹 bind Methods
...
- #### 🔹 do Methods
<a name="do-methods"></a>
  - ⚠️ **do_create_procedure** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'do_create_procedure'_<br>
  - ⚠️ **do_init_procedures** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'do_init_procedures'_<br>
  - ⚠️ **do_query_procedures** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'do_query_procedures'_<br>
  - ⚠️ **do_quit** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'do_quit'_<br>
  - ⚠️ **do_set_i18n** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'do_set_i18n'_<br>
- #### 🔹 emit Methods
...
<a name="get-methods"></a>
  ...
  - ⚠️ **get_pdb_error_handler** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'get_pdb_error_handler'_<br>
  ...
  - ⚠️ **get_temp_procedure** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'get_temp_procedure'_<br>
  - ⚠️ **get_temp_procedures** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'get_temp_procedures'_<br>
- #### 🔹 handler Methods
...
<a name="persistent-methods"></a>
  - ⚠️ **persistent_enable** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'persistent_enable'_<br>
  - ⚠️ **persistent_process** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'persistent_process'_<br>
- #### 🔹 ref Methods
...
<a name="set-methods"></a>
  ...
  - ⚠️ **set_help_domain** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'set_help_domain'_<br>
  - ⚠️ **set_pdb_error_handler** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'set_pdb_error_handler'_<br>
...
<a name="ungrouped-methods"></a>
  ...
  - ⚠️ **directory** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'directory'_<br>
  ...
  - ⚠️ **remove_temp_procedure** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'remove_temp_procedure'_<br>

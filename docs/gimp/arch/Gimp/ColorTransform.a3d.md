...
---
title: "ColorTransform Class Documentation"
date: 2025-06-27
layout: default
---
...
<a name="new-methods"></a>
  ...
  - ⚠️ **new_proofing** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'new_proofing'_<br>
- #### 🔹 notify Methods
...
- #### 🔹 process Methods
<a name="process-methods"></a>
  - ⚠️ **process_buffer** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'process_buffer'_<br>
  - ⚠️ **process_pixels** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'process_pixels'_<br>
- #### 🔹 ref Methods
...
<a name="ungrouped-methods"></a>
  - ⚠️ **can_gegl_copy** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'can_gegl_copy'_<br>

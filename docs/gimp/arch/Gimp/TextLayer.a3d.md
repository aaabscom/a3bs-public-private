...
⚠️ **add_alpha** _Unavailable_ †
⚠️ **add_mask** _Unavailable_ †
- #### 🔹 bind Methods
...
⚠️ **get_antialias** _Unavailable_ †
⚠️ **get_apply_mask** _Unavailable_ †
⚠️ **get_base_direction** _Unavailable_ †
⚠️ **get_blend_space** _Unavailable_ †
...
⚠️ **get_composite_mode** _Unavailable_ †
⚠️ **get_composite_space** _Unavailable_ †
⚠️ **get_data** _Unavailable_ †
⚠️ **get_edit_mask** _Unavailable_ †
⚠️ **get_expanded** _Unavailable_ †
⚠️ **get_filters** _Unavailable_ †
⚠️ **get_font** _Unavailable_ †
⚠️ **get_font_size** _Unavailable_ †
⚠️ **get_format** _Unavailable_ †
⚠️ **get_height** _Unavailable_ †
⚠️ **get_hint_style** _Unavailable_ †
⚠️ **get_id** _Unavailable_ †
⚠️ **get_image** _Unavailable_ †
⚠️ **get_indent** _Unavailable_ †
⚠️ **get_justification** _Unavailable_ †
⚠️ **get_kerning** _Unavailable_ †
⚠️ **get_language** _Unavailable_ †
⚠️ **get_letter_spacing** _Unavailable_ †
⚠️ **get_line_spacing** _Unavailable_ †
⚠️ **get_lock_alpha** _Unavailable_ †
⚠️ **get_lock_content** _Unavailable_ †
⚠️ **get_lock_position** _Unavailable_ †
⚠️ **get_lock_visibility** _Unavailable_ †
⚠️ **get_markup** _Unavailable_ †
⚠️ **get_mask** _Unavailable_ †
⚠️ **get_mode** _Unavailable_ †
...
⚠️ **is_floating_sel** _Unavailable_ †
...
⚠️ **new** _Unavailable_ †
⚠️ **new_from_drawable** _Unavailable_ †
⚠️ **new_from_pixbuf** _Unavailable_ †
⚠️ **new_from_surface** _Unavailable_ †
⚠️ **new_from_visible** _Unavailable_ †
- #### 🔹 notify Methods
...
⚠️ **resize_to_image_size** _Unavailable_ †
- #### 🔹 set Methods
<a name="set-methods"></a>
⚠️ **set_antialias** _Unavailable_ †
⚠️ **set_apply_mask** _Unavailable_ †
⚠️ **set_base_direction** _Unavailable_ †
⚠️ **set_blend_space** _Unavailable_ †
⚠️ **set_color** _Unavailable_ †
⚠️ **set_color_tag** _Unavailable_ †
⚠️ **set_composite_mode** _Unavailable_ †
⚠️ **set_composite_space** _Unavailable_ †
⚠️ **set_data** _Unavailable_ †
⚠️ **set_edit_mask** _Unavailable_ †
⚠️ **set_expanded** _Unavailable_ †
⚠️ **set_font** _Unavailable_ †
⚠️ **set_font_size** _Unavailable_ †
⚠️ **set_hint_style** _Unavailable_ †
⚠️ **set_indent** _Unavailable_ †
⚠️ **set_justification** _Unavailable_ †
⚠️ **set_kerning** _Unavailable_ †
⚠️ **set_language** _Unavailable_ †
⚠️ **set_letter_spacing** _Unavailable_ †
⚠️ **set_line_spacing** _Unavailable_ †
⚠️ **set_lock_alpha** _Unavailable_ †
⚠️ **set_lock_content** _Unavailable_ †
⚠️ **set_lock_position** _Unavailable_ †
⚠️ **set_lock_visibility** _Unavailable_ †
⚠️ **set_markup** _Unavailable_ †
⚠️ **set_mode** _Unavailable_ †

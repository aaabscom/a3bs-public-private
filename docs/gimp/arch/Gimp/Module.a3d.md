...
- #### 🔹 complete Methods
<a name="complete-methods"></a>
  - ⚠️ **complete_interface_info** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'complete_interface_info'_<br>
  - ⚠️ **complete_type_info** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'complete_type_info'_<br>
- #### 🔹 connect Methods
...
- #### 🔹 do Methods
<a name="do-methods"></a>
  - ⚠️ **do_load** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'do_load'_<br>
  - ⚠️ **do_modified** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'do_modified'_<br>
  - ⚠️ **do_unload** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'do_unload'_<br>
- #### 🔹 emit Methods
...
<a name="get-methods"></a>
  - ⚠️ **get_auto_load** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'get_auto_load'_<br>
  ...
  - ⚠️ **get_last_error** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'get_last_error'_<br>
...
<a name="is-methods"></a>
  ...
  - ⚠️ **is_loaded** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'is_loaded'_<br>
  - ⚠️ **is_on_disk** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'is_on_disk'_<br>
- #### 🔹 notify Methods
...
- #### 🔹 query Methods
<a name="query-methods"></a>
  - ⚠️ **query** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'query'_<br>
  - ⚠️ **query_module** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'query_module'_<br>
- #### 🔹 ref Methods
...
<a name="register-methods"></a>
  ...
  - ⚠️ **register_enum** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'register_enum'_<br>
  - ⚠️ **register_flags** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'register_flags'_<br>
  - ⚠️ **register_type** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'register_type'_<br>
- #### 🔹 replace Methods
...
<a name="set-methods"></a>
  - ⚠️ **set_auto_load** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'set_auto_load'_<br>
...
<a name="ungrouped-methods"></a>
  - ⚠️ **add_interface** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'add_interface'_<br>
  ...
  - ⚠️ **unuse** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'unuse'_<br>
  - ⚠️ **use** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'use'_<br>
...
#### 🏷️ Properties
<a name="properties-"></a>
  - **auto  -load**: `gboolean` (read/write)
  - **on  -disk**: `gboolean` (read)
<br>
#### 📣 Signals
<a name="signals-"></a>
<br>- None found

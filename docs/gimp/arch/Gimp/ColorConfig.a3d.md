...
---
title: "ColorConfig Class Documentation"
date: 2025-06-27
layout: default
---
...
<a name="get-methods"></a>
  - ⚠️ **get_cmyk_color_profile** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'get_cmyk_color_profile'_<br>
  - ⚠️ **get_data** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'get_data'_<br>
  - ⚠️ **get_display_bpc** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'get_display_bpc'_<br>
  - ⚠️ **get_display_color_profile** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'get_display_color_profile'_<br>
  - ⚠️ **get_display_intent** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'get_display_intent'_<br>
  - ⚠️ **get_display_optimize** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'get_display_optimize'_<br>
  - ⚠️ **get_display_profile_from_gdk** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'get_display_profile_from_gdk'_<br>
  - ⚠️ **get_gray_color_profile** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'get_gray_color_profile'_<br>
  - ⚠️ **get_mode** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'get_mode'_<br>
  - ⚠️ **get_out_of_gamut_color** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'get_out_of_gamut_color'_<br>
  ...
  - ⚠️ **get_rgb_color_profile** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'get_rgb_color_profile'_<br>
  - ⚠️ **get_simulation_bpc** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'get_simulation_bpc'_<br>
  - ⚠️ **get_simulation_color_profile** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'get_simulation_color_profile'_<br>
  - ⚠️ **get_simulation_gamut_check** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'get_simulation_gamut_check'_<br>
  - ⚠️ **get_simulation_intent** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'get_simulation_intent'_<br>
  - ⚠️ **get_simulation_optimize** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'get_simulation_optimize'_<br>
- #### 🔹 handler Methods
...
#### 🏷️ Properties
<a name="properties-"></a>
  - **mode**: `GimpColorManagementMode` (read/write)
  - **rgb  -profile**: `GimpConfigPath` (read/write)
  - **gray  -profile**: `GimpConfigPath` (read/write)
  - **cmyk  -profile**: `GimpConfigPath` (read/write)
  - **display  -profile**: `GimpConfigPath` (read/write)
  - **display  -profile  -from  -gdk**: `gboolean` (read/write)
  - **simulation  -profile**: `GimpConfigPath` (read/write)
  - **display  -rendering  -intent**: `GimpColorRenderingIntent` (read/write)
  - **display  -use  -black  -point  -compensation**: `gboolean` (read/write)
  - **display  -optimize**: `gboolean` (read/write)
  - **simulation  -rendering  -intent**: `GimpColorRenderingIntent` (read/write)
  - **simulation  -use  -black  -point  -compensation**: `gboolean` (read/write)
  - **simulation  -optimize**: `gboolean` (read/write)
  - **simulation  -gamut  -check**: `gboolean` (read/write)
  - **out  -of  -gamut  -color**: `GeglColor` (read/write)
  - **show  -rgb  -u8**: `gboolean` (read/write)
  - **show  -hsv**: `gboolean` (read/write)
<br>
#### 📣 Signals
<a name="signals-"></a>
<br>- None found

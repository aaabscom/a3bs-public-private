...
<a name="bezier-methods"></a>
  - ⚠️ **bezier_stroke_conicto** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'bezier_stroke_conicto'_<br>
  - ⚠️ **bezier_stroke_cubicto** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'bezier_stroke_cubicto'_<br>
  - ⚠️ **bezier_stroke_lineto** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'bezier_stroke_lineto'_<br>
  - ⚠️ **bezier_stroke_new_ellipse** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'bezier_stroke_new_ellipse'_<br>
  - ⚠️ **bezier_stroke_new_moveto** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'bezier_stroke_new_moveto'_<br>
- #### 🔹 bind Methods
...
<a name="get-methods"></a>
  ...
  - ⚠️ **get_strokes** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'get_strokes'_<br>
  - ⚠️ **get_tattoo** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'get_tattoo'_<br>
  - ⚠️ **get_user_writable_dir** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'get_user_writable_dir'_<br>
...
<a name="new-methods"></a>
  ...
  - ⚠️ **new_from_text_layer** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'new_from_text_layer'_<br>
- #### 🔹 notify Methods
...
<a name="stroke-methods"></a>
  - ⚠️ **stroke_close** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'stroke_close'_<br>
  - ⚠️ **stroke_flip** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'stroke_flip'_<br>
  - ⚠️ **stroke_flip_free** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'stroke_flip_free'_<br>
  - ⚠️ **stroke_get_length** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'stroke_get_length'_<br>
  - ⚠️ **stroke_get_point_at_dist** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'stroke_get_point_at_dist'_<br>
  - ⚠️ **stroke_get_points** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'stroke_get_points'_<br>
  - ⚠️ **stroke_interpolate** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'stroke_interpolate'_<br>
  - ⚠️ **stroke_new_from_points** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'stroke_new_from_points'_<br>
  - ⚠️ **stroke_reverse** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'stroke_reverse'_<br>
  - ⚠️ **stroke_rotate** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'stroke_rotate'_<br>
  - ⚠️ **stroke_scale** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'stroke_scale'_<br>
  - ⚠️ **stroke_translate** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'stroke_translate'_<br>
- #### 🔹 transform Methods
...
<a name="ungrouped-methods"></a>
  ...
  - ⚠️ **free** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'free'_<br>
  ...
  - ⚠️ **parse** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'parse'_<br>
  - ⚠️ **remove_stroke** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'remove_stroke'_<br>
  ...
  - ⚠️ **to_str** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'to_str'_<br>

...
---
title: "Palette Class Documentation"
date: 2025-06-27
layout: default
---
...
<a name="delete-methods"></a>
  ...
  - ⚠️ **delete_entry** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'delete_entry'_<br>
- #### 🔹 disconnect Methods
...
<a name="get-methods"></a>
  ...
  - ⚠️ **get_color_count** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'get_color_count'_<br>
  - ⚠️ **get_colormap** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'get_colormap'_<br>
  - ⚠️ **get_colors** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'get_colors'_<br>
  - ⚠️ **get_columns** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'get_columns'_<br>
  - ⚠️ **get_data** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'get_data'_<br>
  - ⚠️ **get_entry_color** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'get_entry_color'_<br>
  - ⚠️ **get_entry_name** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'get_entry_name'_<br>
...
<a name="set-methods"></a>
  - ⚠️ **set_colormap** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'set_colormap'_<br>
  - ⚠️ **set_columns** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'set_columns'_<br>
  - ⚠️ **set_data** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'set_data'_<br>
  - ⚠️ **set_entry_color** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'set_entry_color'_<br>
  - ⚠️ **set_entry_name** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'set_entry_name'_<br>
...
<a name="ungrouped-methods"></a>
  - ⚠️ **add_entry** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'add_entry'_<br>

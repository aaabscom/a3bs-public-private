...
⚠️ **get_lcms_format** _Unavailable_ †
⚠️ **get_lcms_profile** _Unavailable_ †
⚠️ **get_manufacturer** _Unavailable_ †
⚠️ **get_model** _Unavailable_ †
⚠️ **get_properties** _Unavailable_ †
⚠️ **get_property** _Unavailable_ †
⚠️ **get_qdata** _Unavailable_ †
⚠️ **get_space** _Unavailable_ †
⚠️ **get_summary** _Unavailable_ †
- #### 🔹 handler Methods
...
- #### 🔹 is Methods
<a name="is-methods"></a>
⚠️ **is_cmyk** _Unavailable_ †
⚠️ **is_equal** _Unavailable_ †
⚠️ **is_floating** _Unavailable_ †
⚠️ **is_gray** _Unavailable_ †
⚠️ **is_linear** _Unavailable_ †
⚠️ **is_rgb** _Unavailable_ †
- #### 🔹 new Methods
<a name="new-methods"></a>
⚠️ **new_d50_gray_lab_trc** _Unavailable_ †
⚠️ **new_d65_gray_linear** _Unavailable_ †
⚠️ **new_d65_gray_srgb_trc** _Unavailable_ †
⚠️ **new_from_file** _Unavailable_ †
⚠️ **new_from_icc_profile** _Unavailable_ †
⚠️ **new_from_lcms_profile** _Unavailable_ †
⚠️ **new_linear_from_color_profile** _Unavailable_ †
⚠️ **new_rgb_adobe** _Unavailable_ †
⚠️ **new_rgb_srgb** _Unavailable_ †
⚠️ **new_rgb_srgb_linear** _Unavailable_ †
⚠️ **new_srgb_trc_from_color_profile** _Unavailable_ †
- #### 🔹 notify Methods

...
<a name="get-methods"></a>
  ...
  - ⚠️ **get_lcms_format** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'get_lcms_format'_<br>
  - ⚠️ **get_lcms_profile** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'get_lcms_profile'_<br>
  - ⚠️ **get_manufacturer** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'get_manufacturer'_<br>
  ...
  - ⚠️ **get_space** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'get_space'_<br>
  - ⚠️ **get_summary** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'get_summary'_<br>
- #### 🔹 handler Methods
...
- #### 🔹 is Methods
<a name="is-methods"></a>
  - ⚠️ **is_cmyk** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'is_cmyk'_<br>
  - ⚠️ **is_equal** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'is_equal'_<br>
  ...
  - ⚠️ **is_linear** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'is_linear'_<br>
  - ⚠️ **is_rgb** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'is_rgb'_<br>
- #### 🔹 new Methods
<a name="new-methods"></a>
  - ⚠️ **new_d50_gray_lab_trc** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'new_d50_gray_lab_trc'_<br>
  - ⚠️ **new_d65_gray_linear** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'new_d65_gray_linear'_<br>
  - ⚠️ **new_d65_gray_srgb_trc** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'new_d65_gray_srgb_trc'_<br>
  - ⚠️ **new_from_file** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'new_from_file'_<br>
  - ⚠️ **new_from_icc_profile** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'new_from_icc_profile'_<br>
  - ⚠️ **new_from_lcms_profile** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'new_from_lcms_profile'_<br>
  - ⚠️ **new_linear_from_color_profile** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'new_linear_from_color_profile'_<br>
  - ⚠️ **new_rgb_adobe** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'new_rgb_adobe'_<br>
  - ⚠️ **new_rgb_srgb** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'new_rgb_srgb'_<br>
  - ⚠️ **new_rgb_srgb_linear** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'new_rgb_srgb_linear'_<br>
  - ⚠️ **new_srgb_trc_from_color_profile** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'new_srgb_trc_from_color_profile'_<br>
- #### 🔹 notify Methods
...
<a name="ungrouped-methods"></a>
  ...
  - ⚠️ **save_to_file** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'save_to_file'_<br>

...
---
title: "DrawableFilter Class Documentation"
date: 2025-06-27
layout: default
---

## Table of Contents
- [🔧 Class:DrawableFilter](#class-drawablefilter)
...
<a name="get-methods"></a>
  - ⚠️ **get_blend_mode** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'get_blend_mode'_<br>
  ...
  - ⚠️ **get_operation_name** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'get_operation_name'_<br>
...
<a name="set-methods"></a>
  - ⚠️ **set_aux_input** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'set_aux_input'_<br>
  - ⚠️ **set_blend_mode** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'set_blend_mode'_<br>

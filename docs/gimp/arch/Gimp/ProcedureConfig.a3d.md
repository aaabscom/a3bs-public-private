...
---
title: "ProcedureConfig Class Documentation"
date: 2025-06-27
layout: default
---

## Table of Contents
- [🔧 Class:ProcedureConfig](#class-procedureconfig)
...
<a name="get-methods"></a>
  - ⚠️ **get_choice_id** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'get_choice_id'_<br>
  - ⚠️ **get_color_array** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'get_color_array'_<br>
  - ⚠️ **get_core_object_array** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'get_core_object_array'_<br>
  - ⚠️ **get_data** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'get_data'_<br>
  - ⚠️ **get_procedure** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'get_procedure'_<br>
...
<a name="set-methods"></a>
  - ⚠️ **set_color_array** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'set_color_array'_<br>
  - ⚠️ **set_core_object_array** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'set_core_object_array'_<br>
...
<a name="ungrouped-methods"></a>
  ...
  - ⚠️ **save_metadata** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'save_metadata'_<br>

...
<a name="get-methods"></a>
  ...
  - ⚠️ **get_interpreter_name** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'get_interpreter_name'_<br>
...
<a name="set-methods"></a>
  ...
  - ⚠️ **set_interpreter_name** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'set_interpreter_name'_<br>

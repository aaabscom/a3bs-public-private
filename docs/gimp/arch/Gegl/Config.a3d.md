...
<a name="properties-"></a>
  ...
  - **tile  -cache  -size**: `guint64` (read/write)
  - **chunk  -size**: `gint` (read/write)
  - **swap**: `gchararray` (read/write)
  - **swap  -compression**: `gchararray` (read/write)
  - **tile  -width**: `gint` (read/write)
  - **tile  -height**: `gint` (read/write)
  - **threads**: `gint` (read/write)
  - **use  -opencl**: `gboolean` (read/write)
  - **queue  -size**: `gint` (read/write)
  - **application  -license**: `gchararray` (read/write)
  - **mipmap  -rendering**: `gboolean` (read/write)
<br>
#### 📣 Signals
<a name="signals-"></a>
<br>- None found

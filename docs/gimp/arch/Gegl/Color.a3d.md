...
⚠️ **get_bytes** _Unavailable_ †
⚠️ **get_cmyk** _Unavailable_ †
⚠️ **get_components** _Unavailable_ †
⚠️ **get_data** _Unavailable_ †
⚠️ **get_format** _Unavailable_ †
⚠️ **get_hsla** _Unavailable_ †
⚠️ **get_hsva** _Unavailable_ †
⚠️ **get_properties** _Unavailable_ †
⚠️ **get_property** _Unavailable_ †
⚠️ **get_qdata** _Unavailable_ †
⚠️ **get_rgba** _Unavailable_ †
⚠️ **get_rgba_with_space** _Unavailable_ †
- #### 🔹 handler Methods
...
⚠️ **set_bytes** _Unavailable_ †
⚠️ **set_cmyk** _Unavailable_ †
⚠️ **set_components** _Unavailable_ †
⚠️ **set_data** _Unavailable_ †
⚠️ **set_hsla** _Unavailable_ †
⚠️ **set_hsva** _Unavailable_ †
⚠️ **set_properties** _Unavailable_ †
⚠️ **set_property** _Unavailable_ †
⚠️ **set_rgba** _Unavailable_ †
⚠️ **set_rgba_with_space** _Unavailable_ †
- #### 🔹 steal Methods

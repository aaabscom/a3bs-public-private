...
---
title: "Color Class Documentation"
date: 2025-06-27
layout: default
---
...
<a name="get-methods"></a>
  - ⚠️ **get_bytes** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'get_bytes'_<br>
  - ⚠️ **get_cmyk** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'get_cmyk'_<br>
  - ⚠️ **get_components** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'get_components'_<br>
  ...
  - ⚠️ **get_hsla** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'get_hsla'_<br>
  - ⚠️ **get_hsva** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'get_hsva'_<br>
  ...
  - ⚠️ **get_rgba** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'get_rgba'_<br>
  - ⚠️ **get_rgba_with_space** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'get_rgba_with_space'_<br>
- #### 🔹 handler Methods
...
<a name="set-methods"></a>
  - ⚠️ **set_bytes** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'set_bytes'_<br>
  - ⚠️ **set_cmyk** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'set_cmyk'_<br>
  - ⚠️ **set_components** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'set_components'_<br>
  - ⚠️ **set_data** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'set_data'_<br>
  - ⚠️ **set_hsla** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'set_hsla'_<br>
  - ⚠️ **set_hsva** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'set_hsva'_<br>
  ...
  - ⚠️ **set_rgba** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'set_rgba'_<br>
  - ⚠️ **set_rgba_with_space** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'set_rgba_with_space'_<br>
- #### 🔹 steal Methods

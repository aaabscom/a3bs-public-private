...
<a name="get-methods"></a>
  ...
  - ⚠️ **get_flush_on_destroy** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'get_flush_on_destroy'_<br>
  ...
  - ⚠️ **get_tile_height** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'get_tile_height'_<br>
  - ⚠️ **get_tile_size** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'get_tile_size'_<br>
  - ⚠️ **get_tile_width** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'get_tile_width'_<br>
- #### 🔹 handler Methods
...
<a name="set-methods"></a>
  ...
  - ⚠️ **set_flush_on_destroy** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'set_flush_on_destroy'_<br>
...
<a name="ungrouped-methods"></a>
  ...
  - ⚠️ **command** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'command'_<br>
  ...
  - ⚠️ **peek_storage** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'peek_storage'_<br>
  ...
  - ⚠️ **unlink_swap** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'unlink_swap'_<br>

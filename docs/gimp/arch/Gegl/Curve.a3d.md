...
---
title: "Curve Class Documentation"
date: 2025-06-27
layout: default
---
...
<a name="get-methods"></a>
  ...
  - ⚠️ **get_point** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'get_point'_<br>
  ...
  - ⚠️ **get_y_bounds** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'get_y_bounds'_<br>
- #### 🔹 handler Methods
...
<a name="new-methods"></a>
  ...
  - ⚠️ **new_default** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'new_default'_<br>
- #### 🔹 notify Methods
...
<a name="set-methods"></a>
  ...
  - ⚠️ **set_point** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'set_point'_<br>
...
<a name="ungrouped-methods"></a>
  - ⚠️ **add_point** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'add_point'_<br>
  - ⚠️ **calc_value** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'calc_value'_<br>
  ...
  - ⚠️ **num_points** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'num_points'_<br>

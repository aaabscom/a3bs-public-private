...
---
title: "Node Class Documentation"
date: 2025-06-27
layout: default
---
...
<a name="connect-methods"></a>
  ...
  - ⚠️ **connect_from** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'connect_from'_<br>
  ...
  - ⚠️ **connect_to** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'connect_to'_<br>
- #### 🔹 disconnect Methods
...
<a name="get-methods"></a>
  - ⚠️ **get_bounding_box** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'get_bounding_box'_<br>
  - ⚠️ **get_children** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'get_children'_<br>
  - ⚠️ **get_consumers** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'get_consumers'_<br>
  - ⚠️ **get_data** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'get_data'_<br>
  - ⚠️ **get_gegl_operation** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'get_gegl_operation'_<br>
  - ⚠️ **get_input_proxy** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'get_input_proxy'_<br>
  - ⚠️ **get_operation** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'get_operation'_<br>
  - ⚠️ **get_output_proxy** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'get_output_proxy'_<br>
  - ⚠️ **get_pad_description** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'get_pad_description'_<br>
  - ⚠️ **get_pad_label** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'get_pad_label'_<br>
  - ⚠️ **get_parent** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'get_parent'_<br>
  - ⚠️ **get_passthrough** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'get_passthrough'_<br>
  - ⚠️ **get_producer** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'get_producer'_<br>
...
<a name="is-methods"></a>
  ...
  - ⚠️ **is_graph** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'is_graph'_<br>
- #### 🔹 list Methods
<a name="list-methods"></a>
  - ⚠️ **list_input_pads** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'list_input_pads'_<br>
  - ⚠️ **list_output_pads** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'list_output_pads'_<br>
...
<a name="new-methods"></a>
  ...
  - ⚠️ **new_from_file** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'new_from_file'_<br>
  - ⚠️ **new_from_serialized** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'new_from_serialized'_<br>
  - ⚠️ **new_from_xml** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'new_from_xml'_<br>
  - ⚠️ **new_processor** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'new_processor'_<br>
- #### 🔹 notify Methods
...
<a name="set-methods"></a>
  ...
  - ⚠️ **set_enum_as_string** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'set_enum_as_string'_<br>
  - ⚠️ **set_passthrough** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'set_passthrough'_<br>
  ...
  - ⚠️ **set_time** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'set_time'_<br>
- #### 🔹 steal Methods
...
- #### 🔹 to Methods
<a name="to-methods"></a>
  - ⚠️ **to_xml** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'to_xml'_<br>
  - ⚠️ **to_xml_full** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'to_xml_full'_<br>
- #### 🔹 ungrouped Methods
<a name="ungrouped-methods"></a>
  - ⚠️ **add_child** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'add_child'_<br>
  - ⚠️ **blit_buffer** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'blit_buffer'_<br>
  ...
  - ⚠️ **create_child** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'create_child'_<br>
  - ⚠️ **detect** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'detect'_<br>
  ...
  - ⚠️ **has_pad** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'has_pad'_<br>
  - ⚠️ **link** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'link'_<br>
  ...
  - ⚠️ **process** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'process'_<br>
  - ⚠️ **progress** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'progress'_<br>
  - ⚠️ **remove_child** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'remove_child'_<br>
...
#### 🏷️ Properties
<a name="properties-"></a>
  - **operation**: `gchararray` (read/write)
  - **gegl  -operation**: `GeglOperation` (read/write)
  - **name**: `gchararray` (read/write)
  - **dont  -cache**: `gboolean` (read/write)
  - **cache  -policy**: `GeglCachePolicy` (read/write)
  - **use  -opencl**: `gboolean` (read/write)
  - **passthrough**: `gboolean` (read/write)
<br>
#### 📣 Signals
<a name="signals-"></a>
<br>- None found

...
---
title: "Operation Class Documentation"
date: 2025-06-27
layout: default
---
...
<a name="get-methods"></a>
  ...
  - ⚠️ **get_key** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'get_key'_<br>
  - ⚠️ **get_op_version** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'get_op_version'_<br>
  ...
  - ⚠️ **get_property_key** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'get_property_key'_<br>
...
<a name="list-methods"></a>
  - ⚠️ **list_keys** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'list_keys'_<br>
  - ⚠️ **list_properties** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'list_properties'_<br>
  - ⚠️ **list_property_keys** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'list_property_keys'_<br>
- #### 🔹 notify Methods
...
#### 🏷️ Properties
<a name="properties-"></a>
_Failed to introspect properties: Gegl.Operation.list_properties() takes exactly 1 argument (0 given)_
<br>
#### 📣 Signals
<a name="signals-"></a>
<br>- None found

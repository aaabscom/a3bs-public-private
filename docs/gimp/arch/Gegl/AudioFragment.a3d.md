...
⚠️ **get_channel_layout** _Unavailable_ †
⚠️ **get_channels** _Unavailable_ †
⚠️ **get_data** _Unavailable_ †
⚠️ **get_max_samples** _Unavailable_ †
⚠️ **get_pos** _Unavailable_ †
⚠️ **get_properties** _Unavailable_ †
⚠️ **get_property** _Unavailable_ †
⚠️ **get_qdata** _Unavailable_ †
⚠️ **get_sample_count** _Unavailable_ †
⚠️ **get_sample_rate** _Unavailable_ †
- #### 🔹 handler Methods
...
⚠️ **set_channel_layout** _Unavailable_ †
⚠️ **set_channels** _Unavailable_ †
⚠️ **set_data** _Unavailable_ †
⚠️ **set_max_samples** _Unavailable_ †
⚠️ **set_pos** _Unavailable_ †
⚠️ **set_properties** _Unavailable_ †
⚠️ **set_property** _Unavailable_ †
⚠️ **set_sample_count** _Unavailable_ †
⚠️ **set_sample_rate** _Unavailable_ †
- #### 🔹 steal Methods

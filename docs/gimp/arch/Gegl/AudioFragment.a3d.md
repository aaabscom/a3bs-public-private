...
---
title: "AudioFragment Class Documentation"
date: 2025-06-27
layout: default
---

## Table of Contents
- [🔧 Class:AudioFragment](#class-audiofragment)
...
<a name="get-methods"></a>
  - ⚠️ **get_channel_layout** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'get_channel_layout'_<br>
  ...
  - ⚠️ **get_max_samples** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'get_max_samples'_<br>
  - ⚠️ **get_pos** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'get_pos'_<br>
  ...
  - ⚠️ **get_sample_count** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'get_sample_count'_<br>
  - ⚠️ **get_sample_rate** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'get_sample_rate'_<br>
- #### 🔹 handler Methods
...
<a name="set-methods"></a>
  - ⚠️ **set_channel_layout** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'set_channel_layout'_<br>
  - ⚠️ **set_channels** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'set_channels'_<br>
  - ⚠️ **set_data** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'set_data'_<br>
  - ⚠️ **set_max_samples** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'set_max_samples'_<br>
  - ⚠️ **set_pos** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'set_pos'_<br>
  ...
  - ⚠️ **set_sample_count** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'set_sample_count'_<br>
  - ⚠️ **set_sample_rate** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'set_sample_rate'_<br>
- #### 🔹 steal Methods

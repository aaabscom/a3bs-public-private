...
---
title: "Processor Class Documentation"
date: 2025-06-27
layout: default
---
...
<a name="set-methods"></a>
  ...
  - ⚠️ **set_level** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'set_level'_<br>
  ...
  - ⚠️ **set_rectangle** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'set_rectangle'_<br>
  - ⚠️ **set_scale** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'set_scale'_<br>
- #### 🔹 steal Methods
...
<a name="ungrouped-methods"></a>
  ...
  - ⚠️ **work** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'work'_<br>
### 🔒 Private Methods
...
<a name="properties-"></a>
  - **node**: `GeglNode` (write)
  - **chunksize**: `gint` (read/write)
  - **progress**: `gdouble` (read/write)
  - **rectangle**: `gpointer` (read/write)
<br>
#### 📣 Signals
<a name="signals-"></a>
<br>- None found

...
---
title: "Stats Class Documentation"
date: 2025-06-28
layout: default
---
...
#### 🏷️ Properties
<a name="properties-"></a>
  - **tile  -cache  -total**: `guint64` (read)
  - **tile  -cache  -total  -max**: `guint64` (read)
  - **tile  -cache  -total  -uncompressed**: `guint64` (read)
  - **tile  -cache  -hits**: `gint` (read)
  - **tile  -cache  -misses**: `gint` (read)
  - **swap  -total**: `guint64` (read)
  - **swap  -total  -uncompressed**: `guint64` (read)
  - **swap  -file  -size**: `guint64` (read)
  - **swap  -busy**: `gboolean` (read)
  - **swap  -queued  -total**: `guint64` (read)
  - **swap  -queue  -full**: `gboolean` (read)
  - **swap  -queue  -stalls**: `gint` (read)
  - **swap  -reading**: `gboolean` (read)
  - **swap  -read  -total**: `guint64` (read)
  - **swap  -writing**: `gboolean` (read)
  - **swap  -write  -total**: `guint64` (read)
  - **zoom  -total**: `guint64` (read)
  - **tile  -alloc  -total**: `guint64` (read)
  - **scratch  -total**: `guint64` (read)
  - **assigned  -threads**: `gint` (read)
  - **active  -threads**: `gint` (read)
<br>
#### 📣 Signals
<a name="signals-"></a>
<br>- None found

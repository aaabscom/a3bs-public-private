...
⚠️ **damage_rect** _Unavailable_ †<br>
⚠️ **damage_tile** _Unavailable_ †<br>
- #### 🔹 disconnect Methods
...
⚠️ **flush** _Unavailable_ †<br>
⚠️ **flush_ext** _Unavailable_ †<br>
- #### 🔹 freeze Methods
<a name="freeze-methods"></a>
⚠️ **freeze_changed** _Unavailable_ †<br>
⚠️ **freeze_notify** _Unavailable_ †<br>
- #### 🔹 get Methods
<a name="get-methods"></a>
⚠️ **get** _Unavailable_ †<br>
⚠️ **get_abyss** _Unavailable_ †<br>
⚠️ **get_data** _Unavailable_ †<br>
⚠️ **get_extent** _Unavailable_ †<br>
...
⚠️ **new_for_backend** _Unavailable_ †<br>
- #### 🔹 notify Methods
...
⚠️ **set_abyss** _Unavailable_ †<br>
⚠️ **set_color** _Unavailable_ †<br>
⚠️ **set_color_from_pixel** _Unavailable_ †<br>
...
⚠️ **swap_create_file** _Unavailable_ †<br>
⚠️ **swap_has_file** _Unavailable_ †<br>
⚠️ **swap_remove_file** _Unavailable_ †<br>
- #### 🔹 thaw Methods
<a name="thaw-methods"></a>
⚠️ **thaw_changed** _Unavailable_ †<br>
⚠️ **thaw_notify** _Unavailable_ †<br>
- #### 🔹 ungrouped Methods
<a name="ungrouped-methods"></a>
⚠️ **add_handler** _Unavailable_ †<br>
⚠️ **chain** _Unavailable_ †<br>
⚠️ **clear** _Unavailable_ †<br>
⚠️ **compat_control** _Unavailable_ †<br>
⚠️ **copy** _Unavailable_ †<br>
⚠️ **create_sub_buffer** _Unavailable_ †<br>
...
⚠️ **linear_close** _Unavailable_ †<br>
⚠️ **list_properties** _Unavailable_ †<br>
⚠️ **load** _Unavailable_ †<br>
⚠️ **lock** _Unavailable_ †<br>
⚠️ **newv** _Unavailable_ †<br>
⚠️ **open** _Unavailable_ †<br>
⚠️ **override_property** _Unavailable_ †<br>
⚠️ **remove_handler** _Unavailable_ †<br>
⚠️ **run_dispose** _Unavailable_ †<br>
⚠️ **sample_cleanup** _Unavailable_ †<br>
⚠️ **save** _Unavailable_ †<br>
⚠️ **share_storage** _Unavailable_ †<br>
⚠️ **signal_connect** _Unavailable_ †<br>
⚠️ **unlock** _Unavailable_ †<br>

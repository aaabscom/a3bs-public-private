...
⚠️ **damage_rect** _Unavailable_ †
⚠️ **damage_tile** _Unavailable_ †
- #### 🔹 disconnect Methods
...
⚠️ **flush** _Unavailable_ †
⚠️ **flush_ext** _Unavailable_ †
- #### 🔹 freeze Methods
<a name="freeze-methods"></a>
⚠️ **freeze_changed** _Unavailable_ †
⚠️ **freeze_notify** _Unavailable_ †
- #### 🔹 get Methods
<a name="get-methods"></a>
⚠️ **get** _Unavailable_ †
⚠️ **get_abyss** _Unavailable_ †
⚠️ **get_data** _Unavailable_ †
⚠️ **get_extent** _Unavailable_ †
...
⚠️ **new** _Unavailable_ †
⚠️ **new_for_backend** _Unavailable_ †
- #### 🔹 notify Methods
...
⚠️ **set** _Unavailable_ †
⚠️ **set_abyss** _Unavailable_ †
⚠️ **set_color** _Unavailable_ †
⚠️ **set_color_from_pixel** _Unavailable_ †
⚠️ **set_data** _Unavailable_ †
⚠️ **set_extent** _Unavailable_ †
...
⚠️ **swap_create_file** _Unavailable_ †
⚠️ **swap_has_file** _Unavailable_ †
⚠️ **swap_remove_file** _Unavailable_ †
- #### 🔹 thaw Methods
<a name="thaw-methods"></a>
⚠️ **thaw_changed** _Unavailable_ †
⚠️ **thaw_notify** _Unavailable_ †
- #### 🔹 ungrouped Methods
<a name="ungrouped-methods"></a>
⚠️ **add_handler** _Unavailable_ †
⚠️ **chain** _Unavailable_ †
⚠️ **clear** _Unavailable_ †
⚠️ **compat_control** _Unavailable_ †
⚠️ **copy** _Unavailable_ †
⚠️ **create_sub_buffer** _Unavailable_ †
⚠️ **dup** _Unavailable_ †
⚠️ **find_property** _Unavailable_ †
⚠️ **force_floating** _Unavailable_ †
⚠️ **getv** _Unavailable_ †
⚠️ **is_floating** _Unavailable_ †
⚠️ **linear_close** _Unavailable_ †
⚠️ **list_properties** _Unavailable_ †
⚠️ **load** _Unavailable_ †
⚠️ **lock** _Unavailable_ †
⚠️ **newv** _Unavailable_ †
⚠️ **open** _Unavailable_ †
⚠️ **override_property** _Unavailable_ †
⚠️ **remove_handler** _Unavailable_ †
⚠️ **run_dispose** _Unavailable_ †
⚠️ **sample_cleanup** _Unavailable_ †
⚠️ **save** _Unavailable_ †
⚠️ **share_storage** _Unavailable_ †
⚠️ **signal_connect** _Unavailable_ †
⚠️ **unlock** _Unavailable_ †

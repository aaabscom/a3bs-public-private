...
---
title: "ZoomPreview Class Documentation"
date: 2025-06-28
layout: default
---

## Table of Contents
- [🔧 Class:ZoomPreview](#class-zoompreview)
...
⚠️ **do_draw_buffer** _Unavailable_ †<br>
⚠️ **do_draw_thumb** _Unavailable_ †<br>
...
⚠️ **do_invalidated** _Unavailable_ †<br>
...
⚠️ **do_set_cursor** _Unavailable_ †<br>
...
⚠️ **draw_buffer** _Unavailable_ †<br>
- #### 🔹 emit Methods
...
⚠️ **get_adjustments** _Unavailable_ †<br>
...
⚠️ **get_controls** _Unavailable_ †<br>
⚠️ **get_css_name** _Unavailable_ †<br>
⚠️ **get_data** _Unavailable_ †<br>
⚠️ **get_default_cursor** _Unavailable_ †<br>
...
⚠️ **get_drawable** _Unavailable_ †<br>
...
⚠️ **get_frame** _Unavailable_ †<br>
⚠️ **get_frame_clock** _Unavailable_ †<br>
⚠️ **get_grid** _Unavailable_ †<br>
...
⚠️ **new_with_model_from_drawable** _Unavailable_ †<br>
- #### 🔹 notify Methods
...
⚠️ **set_default_cursor** _Unavailable_ †<br>
...
⚠️ **untransform** _Unavailable_ †<br>
...
<a name="properties-"></a>
  ...
  - **model**: `GimpZoomModel` (read/write)
<br>
#### 📣 Signals
<a name="signals-"></a>
<br>- None found

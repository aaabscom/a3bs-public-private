...
<a name="get-methods"></a>
  ...
  - ⚠️ **get_adjustments** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'get_adjustments'_<br>
  ...
  - ⚠️ **get_drawable** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'get_drawable'_<br>
  ...
  - ⚠️ **get_grid** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'get_grid'_<br>
...
<a name="new-methods"></a>
  ...
  - ⚠️ **new_with_model_from_drawable** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'new_with_model_from_drawable'_<br>
- #### 🔹 notify Methods
...
<a name="set-methods"></a>
  ...
  - ⚠️ **set_policy** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'set_policy'_<br>

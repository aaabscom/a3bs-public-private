...
<a name="get-methods"></a>
  ...
  - ⚠️ **get_button** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'get_button'_<br>
  ...
  - ⚠️ **get_icon_size** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'get_icon_size'_<br>
...
<a name="set-methods"></a>
  ...
  - ⚠️ **set_icon_size** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'set_icon_size'_<br>

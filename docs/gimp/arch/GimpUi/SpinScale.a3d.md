...
<a name="get-methods"></a>
  ...
  - ⚠️ **get_constrain_drag** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'get_constrain_drag'_<br>
  ...
  - ⚠️ **get_gamma** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'get_gamma'_<br>
  ...
  - ⚠️ **get_scale_limits** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'get_scale_limits'_<br>
...
<a name="set-methods"></a>
  ...
  - ⚠️ **set_constrain_drag** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'set_constrain_drag'_<br>
  ...
  - ⚠️ **set_gamma** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'set_gamma'_<br>
  ...
  - ⚠️ **set_scale_limits** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'set_scale_limits'_<br>
...
<a name="unset-methods"></a>
  ...
  - ⚠️ **unset_scale_limits** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'unset_scale_limits'_<br>

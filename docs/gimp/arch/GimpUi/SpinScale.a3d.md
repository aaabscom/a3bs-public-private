...
⚠️ **delete_selection** _Unavailable_ †
⚠️ **delete_text** _Unavailable_ †
- #### 🔹 disconnect Methods
...
⚠️ **do_copy_clipboard** _Unavailable_ †
⚠️ **do_cut_clipboard** _Unavailable_ †
⚠️ **do_damage_event** _Unavailable_ †
⚠️ **do_delete_event** _Unavailable_ †
⚠️ **do_delete_from_cursor** _Unavailable_ †
...
⚠️ **do_get_frame_size** _Unavailable_ †
...
⚠️ **do_get_text_area_size** _Unavailable_ †
...
⚠️ **do_input** _Unavailable_ †
⚠️ **do_insert_at_cursor** _Unavailable_ †
⚠️ **do_insert_emoji** _Unavailable_ †
...
⚠️ **do_move_cursor** _Unavailable_ †
⚠️ **do_move_focus** _Unavailable_ †
⚠️ **do_output** _Unavailable_ †
⚠️ **do_parent_set** _Unavailable_ †
⚠️ **do_paste_clipboard** _Unavailable_ †
⚠️ **do_populate_popup** _Unavailable_ †
...
⚠️ **do_toggle_direction** _Unavailable_ †
⚠️ **do_toggle_overwrite** _Unavailable_ †
...
⚠️ **get_activates_default** _Unavailable_ †
⚠️ **get_adjustment** _Unavailable_ †
...
⚠️ **get_completion** _Unavailable_ †
⚠️ **get_composite_name** _Unavailable_ †
⚠️ **get_constrain_drag** _Unavailable_ †
⚠️ **get_css_name** _Unavailable_ †
⚠️ **get_current_icon_drag_source** _Unavailable_ †
⚠️ **get_cursor_hadjustment** _Unavailable_ †
...
⚠️ **get_gamma** _Unavailable_ †
⚠️ **get_halign** _Unavailable_ †
⚠️ **get_has_frame** _Unavailable_ †
⚠️ **get_has_tooltip** _Unavailable_ †
⚠️ **get_has_window** _Unavailable_ †
⚠️ **get_hexpand** _Unavailable_ †
⚠️ **get_hexpand_set** _Unavailable_ †
⚠️ **get_icon_activatable** _Unavailable_ †
⚠️ **get_icon_area** _Unavailable_ †
⚠️ **get_icon_at_pos** _Unavailable_ †
⚠️ **get_icon_gicon** _Unavailable_ †
⚠️ **get_icon_name** _Unavailable_ †
⚠️ **get_icon_pixbuf** _Unavailable_ †
⚠️ **get_icon_sensitive** _Unavailable_ †
⚠️ **get_icon_stock** _Unavailable_ †
⚠️ **get_icon_storage_type** _Unavailable_ †
⚠️ **get_icon_tooltip_markup** _Unavailable_ †
⚠️ **get_icon_tooltip_text** _Unavailable_ †
⚠️ **get_increments** _Unavailable_ †
⚠️ **get_inner_border** _Unavailable_ †
⚠️ **get_input_hints** _Unavailable_ †
⚠️ **get_input_purpose** _Unavailable_ †
⚠️ **get_internal_child** _Unavailable_ †
⚠️ **get_invisible_char** _Unavailable_ †
⚠️ **get_label** _Unavailable_ †
⚠️ **get_layout** _Unavailable_ †
⚠️ **get_layout_offsets** _Unavailable_ †
...
⚠️ **get_max_length** _Unavailable_ †
⚠️ **get_max_width_chars** _Unavailable_ †
⚠️ **get_mnemonic_keyval** _Unavailable_ †
...
⚠️ **get_progress_fraction** _Unavailable_ †
⚠️ **get_progress_pulse_step** _Unavailable_ †
...
⚠️ **get_tabs** _Unavailable_ †
⚠️ **get_template_child** _Unavailable_ †
⚠️ **get_text** _Unavailable_ †
⚠️ **get_text_area** _Unavailable_ †
⚠️ **get_text_length** _Unavailable_ †
...
⚠️ **new** _Unavailable_ †
⚠️ **new_with_buffer** _Unavailable_ †
...
⚠️ **reset_im_context** _Unavailable_ †
...
⚠️ **set_activates_default** _Unavailable_ †
⚠️ **set_adjustment** _Unavailable_ †
⚠️ **set_alignment** _Unavailable_ †
⚠️ **set_allocation** _Unavailable_ †
⚠️ **set_app_paintable** _Unavailable_ †
⚠️ **set_attributes** _Unavailable_ †
⚠️ **set_buffer** _Unavailable_ †
...
⚠️ **set_completion** _Unavailable_ †
⚠️ **set_composite_name** _Unavailable_ †
⚠️ **set_connect_func** _Unavailable_ †
⚠️ **set_constrain_drag** _Unavailable_ †
⚠️ **set_css_name** _Unavailable_ †
⚠️ **set_cursor_hadjustment** _Unavailable_ †
...
⚠️ **set_editable** _Unavailable_ †
⚠️ **set_events** _Unavailable_ †
⚠️ **set_focus_on_click** _Unavailable_ †
⚠️ **set_font_map** _Unavailable_ †
⚠️ **set_font_options** _Unavailable_ †
⚠️ **set_gamma** _Unavailable_ †
⚠️ **set_halign** _Unavailable_ †
⚠️ **set_has_frame** _Unavailable_ †
⚠️ **set_has_tooltip** _Unavailable_ †
⚠️ **set_has_window** _Unavailable_ †
⚠️ **set_hexpand** _Unavailable_ †
⚠️ **set_hexpand_set** _Unavailable_ †
⚠️ **set_icon_activatable** _Unavailable_ †
⚠️ **set_icon_drag_source** _Unavailable_ †
⚠️ **set_icon_from_gicon** _Unavailable_ †
⚠️ **set_icon_from_icon_name** _Unavailable_ †
⚠️ **set_icon_from_pixbuf** _Unavailable_ †
⚠️ **set_icon_from_stock** _Unavailable_ †
⚠️ **set_icon_sensitive** _Unavailable_ †
⚠️ **set_icon_tooltip_markup** _Unavailable_ †
⚠️ **set_icon_tooltip_text** _Unavailable_ †
⚠️ **set_increments** _Unavailable_ †
⚠️ **set_inner_border** _Unavailable_ †
⚠️ **set_input_hints** _Unavailable_ †
⚠️ **set_input_purpose** _Unavailable_ †
⚠️ **set_invisible_char** _Unavailable_ †
...
⚠️ **unset_invisible_char** _Unavailable_ †
⚠️ **unset_scale_limits** _Unavailable_ †
...
⚠️ **im_context_filter_keypress** _Unavailable_ †
...
⚠️ **select_region** _Unavailable_ †
⚠️ **shape_combine_region** _Unavailable_ †
⚠️ **spin** _Unavailable_ †
⚠️ **start_editing** _Unavailable_ †
⚠️ **text_index_to_layout_index** _Unavailable_ †

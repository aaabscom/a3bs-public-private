...
---
title: "CellRendererToggle Class Documentation"
date: 2025-06-28
layout: default
---

## Table of Contents
- [🔧 Class:CellRendererToggle](#class-cellrenderertoggle)
...
⚠️ **do_editing_canceled** _Unavailable_ †<br>
⚠️ **do_editing_started** _Unavailable_ †<br>
⚠️ **do_get_aligned_area** _Unavailable_ †<br>
...
⚠️ **do_get_size** _Unavailable_ †<br>
⚠️ **do_render** _Unavailable_ †<br>
⚠️ **do_start_editing** _Unavailable_ †<br>
⚠️ **do_toggled** _Unavailable_ †<br>
- #### 🔹 emit Methods
...
⚠️ **get_activatable** _Unavailable_ †<br>
⚠️ **get_active** _Unavailable_ †<br>
⚠️ **get_aligned_area** _Unavailable_ †<br>
⚠️ **get_alignment** _Unavailable_ †<br>
⚠️ **get_data** _Unavailable_ †<br>
⚠️ **get_fixed_size** _Unavailable_ †<br>
...
- #### 🔹 is Methods
<a name="is-methods"></a>
⚠️ **is_activatable** _Unavailable_ †<br>
...
⚠️ **stop_editing** _Unavailable_ †<br>
...
<a name="properties-"></a>
  ...
  - **override  -background**: `gboolean` (read/write)
<br>
#### 📣 Signals
<a name="signals-"></a>
<br>- None found

...
<a name="do-methods"></a>
  ...
  - ⚠️ **do_toggled** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'do_toggled'_<br>
- #### 🔹 emit Methods
...
<a name="get-methods"></a>
  - ⚠️ **get_activatable** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'get_activatable'_<br>
  ...
  - ⚠️ **get_radio** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'get_radio'_<br>
...
<a name="set-methods"></a>
  ...
  - ⚠️ **set_activatable** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'set_activatable'_<br>
  ...
  - ⚠️ **set_radio** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'set_radio'_<br>

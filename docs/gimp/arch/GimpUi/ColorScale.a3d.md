...
---
title: "ColorScale Class Documentation"
date: 2025-06-27
layout: default
---
...
<a name="add-methods"></a>
  ...
  - ⚠️ **add_mark** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'add_mark'_<br>
...
<a name="do-methods"></a>
  ...
  - ⚠️ **do_adjust_bounds** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'do_adjust_bounds'_<br>
  ...
  - ⚠️ **do_draw_value** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'do_draw_value'_<br>
  ...
  - ⚠️ **do_format_value** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'do_format_value'_<br>
  - ⚠️ **do_get_accessible** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'do_get_accessible'_<br>
  - ⚠️ **do_get_layout_offsets** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'do_get_layout_offsets'_<br>
  ...
  - ⚠️ **do_get_range_border** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'do_get_range_border'_<br>
  - ⚠️ **do_get_range_size_request** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'do_get_range_size_request'_<br>
  ...
  - ⚠️ **do_move_slider** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'do_move_slider'_<br>
...
<a name="get-methods"></a>
  ...
  - ⚠️ **get_draw_value** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'get_draw_value'_<br>
  - ⚠️ **get_events** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'get_events'_<br>
  - ⚠️ **get_fill_level** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'get_fill_level'_<br>
  - ⚠️ **get_flippable** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'get_flippable'_<br>
  ...
  - ⚠️ **get_has_origin** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'get_has_origin'_<br>
  ...
  - ⚠️ **get_inverted** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'get_inverted'_<br>
  ...
  - ⚠️ **get_lower_stepper_sensitivity** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'get_lower_stepper_sensitivity'_<br>
  ...
  - ⚠️ **get_min_slider_size** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'get_min_slider_size'_<br>
  ...
  - ⚠️ **get_range_rect** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'get_range_rect'_<br>
  ...
  - ⚠️ **get_restrict_to_fill_level** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'get_restrict_to_fill_level'_<br>
  - ⚠️ **get_root_window** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'get_root_window'_<br>
  - ⚠️ **get_round_digits** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'get_round_digits'_<br>
  ...
  - ⚠️ **get_show_fill_level** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'get_show_fill_level'_<br>
  - ⚠️ **get_size_request** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'get_size_request'_<br>
  - ⚠️ **get_slider_range** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'get_slider_range'_<br>
  - ⚠️ **get_slider_size_fixed** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'get_slider_size_fixed'_<br>
  ...
  - ⚠️ **get_upper_stepper_sensitivity** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'get_upper_stepper_sensitivity'_<br>
  ...
  - ⚠️ **get_value_pos** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'get_value_pos'_<br>
...
<a name="set-methods"></a>
  ...
  - ⚠️ **set_draw_value** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'set_draw_value'_<br>
  - ⚠️ **set_events** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'set_events'_<br>
  - ⚠️ **set_fill_level** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'set_fill_level'_<br>
  - ⚠️ **set_flippable** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'set_flippable'_<br>
  ...
  - ⚠️ **set_has_origin** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'set_has_origin'_<br>
  ...
  - ⚠️ **set_inverted** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'set_inverted'_<br>
  - ⚠️ **set_lower_stepper_sensitivity** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'set_lower_stepper_sensitivity'_<br>
  ...
  - ⚠️ **set_min_slider_size** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'set_min_slider_size'_<br>
  ...
  - ⚠️ **set_restrict_to_fill_level** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'set_restrict_to_fill_level'_<br>
  - ⚠️ **set_round_digits** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'set_round_digits'_<br>
  - ⚠️ **set_sensitive** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'set_sensitive'_<br>
  - ⚠️ **set_show_fill_level** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'set_show_fill_level'_<br>
  - ⚠️ **set_size_request** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'set_size_request'_<br>
  - ⚠️ **set_slider_size_fixed** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'set_slider_size_fixed'_<br>
  ...
  - ⚠️ **set_upper_stepper_sensitivity** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'set_upper_stepper_sensitivity'_<br>
  ...
  - ⚠️ **set_value_pos** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'set_value_pos'_<br>
...
<a name="ungrouped-methods"></a>
  ...
  - ⚠️ **clear_marks** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'clear_marks'_<br>
...
<a name="properties-"></a>
  ...
  - **channel**: `GimpColorSelectorChannel` (read/write)
<br>
#### 📣 Signals
<a name="signals-"></a>
<br>- None found

...
---
title: "IntRadioFrame Class Documentation"
date: 2025-06-27
layout: default
---

## Table of Contents
- [🔧 Class:IntRadioFrame](#class-intradioframe)
...
<a name="do-methods"></a>
  ...
  - ⚠️ **do_compute_child_allocation** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'do_compute_child_allocation'_<br>
...
<a name="get-methods"></a>
  ...
  - ⚠️ **get_label_align** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'get_label_align'_<br>
  - ⚠️ **get_label_widget** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'get_label_widget'_<br>
  ...
  - ⚠️ **get_shadow_type** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'get_shadow_type'_<br>
...
<a name="new-methods"></a>
  ...
  - ⚠️ **new_from_store** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'new_from_store'_<br>
- #### 🔹 notify Methods
...
<a name="set-methods"></a>
  ...
  - ⚠️ **set_label_align** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'set_label_align'_<br>
  - ⚠️ **set_label_widget** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'set_label_widget'_<br>
  ...
  - ⚠️ **set_shadow_type** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'set_shadow_type'_<br>

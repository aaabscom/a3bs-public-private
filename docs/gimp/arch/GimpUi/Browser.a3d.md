...
---
title: "Browser Class Documentation"
date: 2025-06-27
layout: default
---
...
- #### 🔹 do Methods
<a name="do-methods"></a>
  - ⚠️ **do_accept_position** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'do_accept_position'_<br>
  ...
  - ⚠️ **do_cancel_position** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'do_cancel_position'_<br>
  ...
  - ⚠️ **do_cycle_child_focus** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'do_cycle_child_focus'_<br>
  - ⚠️ **do_cycle_handle_focus** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'do_cycle_handle_focus'_<br>
  ...
  - ⚠️ **do_move_handle** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'do_move_handle'_<br>
  ...
  - ⚠️ **do_toggle_handle_focus** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'do_toggle_handle_focus'_<br>
...
<a name="get-methods"></a>
  ...
  - ⚠️ **get_child1** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'get_child1'_<br>
  - ⚠️ **get_child2** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'get_child2'_<br>
  ...
  - ⚠️ **get_handle_window** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'get_handle_window'_<br>
  ...
  - ⚠️ **get_left_vbox** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'get_left_vbox'_<br>
  ...
  - ⚠️ **get_right_vbox** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'get_right_vbox'_<br>
  ...
  - ⚠️ **get_wide_handle** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'get_wide_handle'_<br>
...
<a name="set-methods"></a>
  ...
  - ⚠️ **set_search_summary** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'set_search_summary'_<br>
  ...
  - ⚠️ **set_wide_handle** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'set_wide_handle'_<br>
  - ⚠️ **set_widget** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'set_widget'_<br>
...
<a name="show-methods"></a>
  ...
  - ⚠️ **show_message** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'show_message'_<br>
...
<a name="ungrouped-methods"></a>
  ...
  - ⚠️ **add1** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'add1'_<br>
  - ⚠️ **add2** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'add2'_<br>
  ...
  - ⚠️ **pack1** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'pack1'_<br>
  - ⚠️ **pack2** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'pack2'_<br>

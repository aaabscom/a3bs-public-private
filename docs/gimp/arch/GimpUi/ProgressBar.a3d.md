...
<a name="get-methods"></a>
  ...
  - ⚠️ **get_fraction** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'get_fraction'_<br>
  ...
  - ⚠️ **get_pulse_step** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'get_pulse_step'_<br>
  ...
  - ⚠️ **get_show_text** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'get_show_text'_<br>
...
<a name="set-methods"></a>
  ...
  - ⚠️ **set_fraction** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'set_fraction'_<br>
  ...
  - ⚠️ **set_pulse_step** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'set_pulse_step'_<br>
  ...
  - ⚠️ **set_show_text** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'set_show_text'_<br>
...
<a name="ungrouped-methods"></a>
  ...
  - ⚠️ **pulse** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'pulse'_<br>

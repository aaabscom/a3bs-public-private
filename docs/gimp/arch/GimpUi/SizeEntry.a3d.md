...
---
title: "SizeEntry Class Documentation"
date: 2025-06-27
layout: default
---

## Table of Contents
- [🔧 Class:SizeEntry](#class-sizeentry)
...
<a name="add-methods"></a>
  ...
  - ⚠️ **add_field** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'add_field'_<br>
...
<a name="attach-methods"></a>
  ...
  - ⚠️ **attach_label** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'attach_label'_<br>
...
<a name="get-methods"></a>
  ...
  - ⚠️ **get_help_widget** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'get_help_widget'_<br>
  ...
  - ⚠️ **get_n_fields** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'get_n_fields'_<br>
  ...
  - ⚠️ **get_refval** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'get_refval'_<br>
  ...
  - ⚠️ **get_unit_combo** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'get_unit_combo'_<br>
...
<a name="set-methods"></a>
  ...
  - ⚠️ **set_pixel_digits** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'set_pixel_digits'_<br>
  ...
  - ⚠️ **set_refval** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'set_refval'_<br>
  - ⚠️ **set_refval_boundaries** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'set_refval_boundaries'_<br>
  - ⚠️ **set_refval_digits** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'set_refval_digits'_<br>
  ...
  - ⚠️ **set_value_boundaries** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'set_value_boundaries'_<br>
...
<a name="show-methods"></a>
  ...
  - ⚠️ **show_unit_menu** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'show_unit_menu'_<br>
- #### 🔹 size Methods

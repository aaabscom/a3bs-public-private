...
⚠️ **activate_default** _Unavailable_ †
⚠️ **activate_focus** _Unavailable_ †
⚠️ **activate_key** _Unavailable_ †
- #### 🔹 add Methods
<a name="add-methods"></a>
⚠️ **add** _Unavailable_ †
⚠️ **add_accel_group** _Unavailable_ †
⚠️ **add_accelerator** _Unavailable_ †
⚠️ **add_action_widget** _Unavailable_ †
⚠️ **add_button** _Unavailable_ †
⚠️ **add_buttons** _Unavailable_ †
⚠️ **add_child** _Unavailable_ †
⚠️ **add_choice** _Unavailable_ †
⚠️ **add_device_events** _Unavailable_ †
⚠️ **add_events** _Unavailable_ †
⚠️ **add_filter** _Unavailable_ †
⚠️ **add_mnemonic** _Unavailable_ †
⚠️ **add_mnemonic_label** _Unavailable_ †
⚠️ **add_shortcut_folder** _Unavailable_ †
⚠️ **add_shortcut_folder_uri** _Unavailable_ †
⚠️ **add_tick_callback** _Unavailable_ †
- #### 🔹 begin Methods
<a name="begin-methods"></a>
⚠️ **begin_move_drag** _Unavailable_ †
⚠️ **begin_resize_drag** _Unavailable_ †
- #### 🔹 bind Methods
...
- #### 🔹 do Methods
<a name="do-methods"></a>
⚠️ **do_activate_default** _Unavailable_ †
⚠️ **do_activate_focus** _Unavailable_ †
...
⚠️ **do_enable_debugging** _Unavailable_ †
...
⚠️ **do_keys_changed** _Unavailable_ †
...
⚠️ **fullscreen** _Unavailable_ †
⚠️ **fullscreen_on_monitor** _Unavailable_ †
- #### 🔹 get Methods
<a name="get-methods"></a>
⚠️ **get_accept_focus** _Unavailable_ †
⚠️ **get_accessible** _Unavailable_ †
⚠️ **get_action** _Unavailable_ †
⚠️ **get_action_area** _Unavailable_ †
...
⚠️ **get_application** _Unavailable_ †
⚠️ **get_attached_to** _Unavailable_ †
...
⚠️ **get_choice** _Unavailable_ †
⚠️ **get_clip** _Unavailable_ †
⚠️ **get_clipboard** _Unavailable_ †
⚠️ **get_composite_name** _Unavailable_ †
⚠️ **get_content_area** _Unavailable_ †
⚠️ **get_create_folders** _Unavailable_ †
⚠️ **get_css_name** _Unavailable_ †
⚠️ **get_current_folder** _Unavailable_ †
⚠️ **get_current_folder_file** _Unavailable_ †
⚠️ **get_current_folder_uri** _Unavailable_ †
⚠️ **get_current_name** _Unavailable_ †
⚠️ **get_data** _Unavailable_ †
⚠️ **get_decorated** _Unavailable_ †
⚠️ **get_default_direction** _Unavailable_ †
⚠️ **get_default_icon_list** _Unavailable_ †
⚠️ **get_default_icon_name** _Unavailable_ †
⚠️ **get_default_size** _Unavailable_ †
⚠️ **get_default_style** _Unavailable_ †
⚠️ **get_default_widget** _Unavailable_ †
⚠️ **get_deletable** _Unavailable_ †
⚠️ **get_destroy_with_parent** _Unavailable_ †
...
⚠️ **get_do_overwrite_confirmation** _Unavailable_ †
⚠️ **get_double_buffered** _Unavailable_ †
⚠️ **get_events** _Unavailable_ †
⚠️ **get_extra_widget** _Unavailable_ †
⚠️ **get_file** _Unavailable_ †
⚠️ **get_filename** _Unavailable_ †
⚠️ **get_filenames** _Unavailable_ †
⚠️ **get_files** _Unavailable_ †
⚠️ **get_filter** _Unavailable_ †
⚠️ **get_focus** _Unavailable_ †
...
⚠️ **get_mnemonic_modifier** _Unavailable_ †
⚠️ **get_mnemonics_visible** _Unavailable_ †
⚠️ **get_modal** _Unavailable_ †
...
⚠️ **get_preview_file** _Unavailable_ †
⚠️ **get_preview_filename** _Unavailable_ †
⚠️ **get_preview_uri** _Unavailable_ †
⚠️ **get_preview_widget** _Unavailable_ †
⚠️ **get_preview_widget_active** _Unavailable_ †
...
⚠️ **get_resizable** _Unavailable_ †
⚠️ **get_resize_grip_area** _Unavailable_ †
⚠️ **get_resize_mode** _Unavailable_ †
⚠️ **get_response_for_widget** _Unavailable_ †
⚠️ **get_role** _Unavailable_ †
⚠️ **get_root_window** _Unavailable_ †
⚠️ **get_scale_factor** _Unavailable_ †
⚠️ **get_screen** _Unavailable_ †
⚠️ **get_select_multiple** _Unavailable_ †
⚠️ **get_sensitive** _Unavailable_ †
⚠️ **get_settings** _Unavailable_ †
⚠️ **get_show_hidden** _Unavailable_ †
⚠️ **get_size** _Unavailable_ †
⚠️ **get_size_request** _Unavailable_ †
⚠️ **get_skip_pager_hint** _Unavailable_ †
⚠️ **get_skip_taskbar_hint** _Unavailable_ †
...
⚠️ **get_transient_for** _Unavailable_ †
⚠️ **get_type_hint** _Unavailable_ †
⚠️ **get_urgency_hint** _Unavailable_ †
⚠️ **get_uri** _Unavailable_ †
⚠️ **get_uris** _Unavailable_ †
⚠️ **get_use_preview_label** _Unavailable_ †
...
⚠️ **get_widget_for_response** _Unavailable_ †
⚠️ **get_window** _Unavailable_ †
⚠️ **get_window_type** _Unavailable_ †
- #### 🔹 grab Methods
...
⚠️ **has_group** _Unavailable_ †
⚠️ **has_rc_style** _Unavailable_ †
⚠️ **has_screen** _Unavailable_ †
⚠️ **has_toplevel_focus** _Unavailable_ †
...
⚠️ **list_filters** _Unavailable_ †
⚠️ **list_mnemonic_labels** _Unavailable_ †
⚠️ **list_properties** _Unavailable_ †
⚠️ **list_shortcut_folder_uris** _Unavailable_ †
⚠️ **list_shortcut_folders** _Unavailable_ †
⚠️ **list_style_properties** _Unavailable_ †
⚠️ **list_toplevels** _Unavailable_ †
- #### 🔹 modify Methods
...
⚠️ **present** _Unavailable_ †
⚠️ **present_with_time** _Unavailable_ †
- #### 🔹 propagate Methods
<a name="propagate-methods"></a>
⚠️ **propagate_draw** _Unavailable_ †
⚠️ **propagate_key_event** _Unavailable_ †
- #### 🔹 queue Methods
...
⚠️ **remove_accel_group** _Unavailable_ †
⚠️ **remove_accelerator** _Unavailable_ †
⚠️ **remove_choice** _Unavailable_ †
⚠️ **remove_filter** _Unavailable_ †
⚠️ **remove_mnemonic** _Unavailable_ †
⚠️ **remove_mnemonic_label** _Unavailable_ †
⚠️ **remove_shortcut_folder** _Unavailable_ †
⚠️ **remove_shortcut_folder_uri** _Unavailable_ †
...
⚠️ **resize_grip_is_visible** _Unavailable_ †
⚠️ **resize_to_geometry** _Unavailable_ †
- #### 🔹 run Methods
...
⚠️ **select_all** _Unavailable_ †
⚠️ **select_file** _Unavailable_ †
⚠️ **select_filename** _Unavailable_ †
⚠️ **select_uri** _Unavailable_ †
- #### 🔹 send Methods
...
⚠️ **set_accept_focus** _Unavailable_ †
...
⚠️ **set_alternative_button_order_from_array** _Unavailable_ †
⚠️ **set_app_paintable** _Unavailable_ †
⚠️ **set_application** _Unavailable_ †
⚠️ **set_attached_to** _Unavailable_ †
⚠️ **set_auto_startup_notification** _Unavailable_ †
...
⚠️ **set_choice** _Unavailable_ †
⚠️ **set_clip** _Unavailable_ †
⚠️ **set_composite_name** _Unavailable_ †
⚠️ **set_connect_func** _Unavailable_ †
⚠️ **set_create_folders** _Unavailable_ †
⚠️ **set_css_name** _Unavailable_ †
⚠️ **set_current_folder** _Unavailable_ †
⚠️ **set_current_folder_file** _Unavailable_ †
⚠️ **set_current_folder_uri** _Unavailable_ †
⚠️ **set_current_name** _Unavailable_ †
⚠️ **set_data** _Unavailable_ †
⚠️ **set_decorated** _Unavailable_ †
⚠️ **set_default** _Unavailable_ †
⚠️ **set_default_direction** _Unavailable_ †
⚠️ **set_default_geometry** _Unavailable_ †
⚠️ **set_default_icon** _Unavailable_ †
⚠️ **set_default_icon_from_file** _Unavailable_ †
⚠️ **set_default_icon_list** _Unavailable_ †
⚠️ **set_default_icon_name** _Unavailable_ †
⚠️ **set_default_response** _Unavailable_ †
⚠️ **set_default_size** _Unavailable_ †
⚠️ **set_deletable** _Unavailable_ †
⚠️ **set_destroy_with_parent** _Unavailable_ †
⚠️ **set_device_enabled** _Unavailable_ †
⚠️ **set_device_events** _Unavailable_ †
⚠️ **set_direction** _Unavailable_ †
⚠️ **set_do_overwrite_confirmation** _Unavailable_ †
⚠️ **set_double_buffered** _Unavailable_ †
⚠️ **set_events** _Unavailable_ †
⚠️ **set_extra_widget** _Unavailable_ †
⚠️ **set_file** _Unavailable_ †
⚠️ **set_filename** _Unavailable_ †
⚠️ **set_filter** _Unavailable_ †
⚠️ **set_focus** _Unavailable_ †
...
⚠️ **set_focus_on_map** _Unavailable_ †
⚠️ **set_focus_vadjustment** _Unavailable_ †
⚠️ **set_focus_visible** _Unavailable_ †
⚠️ **set_font_map** _Unavailable_ †
⚠️ **set_font_options** _Unavailable_ †
⚠️ **set_geometry_hints** _Unavailable_ †
⚠️ **set_gravity** _Unavailable_ †
⚠️ **set_halign** _Unavailable_ †
⚠️ **set_has_resize_grip** _Unavailable_ †
⚠️ **set_has_tooltip** _Unavailable_ †
⚠️ **set_has_user_ref_count** _Unavailable_ †
⚠️ **set_has_window** _Unavailable_ †
⚠️ **set_hexpand** _Unavailable_ †
⚠️ **set_hexpand_set** _Unavailable_ †
⚠️ **set_hide_titlebar_when_maximized** _Unavailable_ †
⚠️ **set_icon** _Unavailable_ †
⚠️ **set_icon_from_file** _Unavailable_ †
⚠️ **set_icon_list** _Unavailable_ †
⚠️ **set_icon_name** _Unavailable_ †
⚠️ **set_interactive_debugging** _Unavailable_ †
⚠️ **set_keep_above** _Unavailable_ †
⚠️ **set_keep_below** _Unavailable_ †
⚠️ **set_local_only** _Unavailable_ †
...
⚠️ **set_mnemonic_modifier** _Unavailable_ †
⚠️ **set_mnemonics_visible** _Unavailable_ †
⚠️ **set_modal** _Unavailable_ †
...
⚠️ **set_preview_widget** _Unavailable_ †
⚠️ **set_preview_widget_active** _Unavailable_ †
...
⚠️ **set_resizable** _Unavailable_ †
⚠️ **set_resize_mode** _Unavailable_ †
⚠️ **set_response_sensitive** _Unavailable_ †
⚠️ **set_role** _Unavailable_ †
⚠️ **set_screen** _Unavailable_ †
⚠️ **set_select_multiple** _Unavailable_ †
⚠️ **set_sensitive** _Unavailable_ †
⚠️ **set_show_hidden** _Unavailable_ †
⚠️ **set_size_request** _Unavailable_ †
⚠️ **set_skip_pager_hint** _Unavailable_ †
⚠️ **set_skip_taskbar_hint** _Unavailable_ †
⚠️ **set_startup_id** _Unavailable_ †
...
⚠️ **set_titlebar** _Unavailable_ †
⚠️ **set_tooltip_markup** _Unavailable_ †
⚠️ **set_tooltip_text** _Unavailable_ †
⚠️ **set_tooltip_window** _Unavailable_ †
⚠️ **set_transient_for** _Unavailable_ †
⚠️ **set_type_hint** _Unavailable_ †
⚠️ **set_urgency_hint** _Unavailable_ †
⚠️ **set_uri** _Unavailable_ †
⚠️ **set_use_preview_label** _Unavailable_ †
...
⚠️ **unselect_all** _Unavailable_ †
⚠️ **unselect_file** _Unavailable_ †
⚠️ **unselect_filename** _Unavailable_ †
⚠️ **unselect_uri** _Unavailable_ †
- #### 🔹 unset Methods
...
⚠️ **map** _Unavailable_ †
⚠️ **maximize** _Unavailable_ †
⚠️ **mnemonic_activate** _Unavailable_ †
⚠️ **move** _Unavailable_ †
⚠️ **new** _Unavailable_ †
⚠️ **newv** _Unavailable_ †
⚠️ **parse_geometry** _Unavailable_ †

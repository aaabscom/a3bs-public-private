...
---
title: "ColorProfileChooserDialog Class Documentation"
date: 2025-06-27
layout: default
---

## Table of Contents
- [🔧 Class:ColorProfileChooserDialog](#class-colorprofilechooserdialog)
  - [ 🔹 Public:Methods](#public-methods)
    ...
    - [ 🔹 unselect:Methods](#unselect-methods)
...
<a name="activate-methods"></a>
  ...
  - ⚠️ **activate_default** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'activate_default'_<br>
  - ⚠️ **activate_focus** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'activate_focus'_<br>
  - ⚠️ **activate_key** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'activate_key'_<br>
- #### 🔹 add Methods
<a name="add-methods"></a>
  - ⚠️ **add** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'add'_<br>
  - ⚠️ **add_accel_group** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'add_accel_group'_<br>
  - ⚠️ **add_accelerator** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'add_accelerator'_<br>
  - ⚠️ **add_action_widget** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'add_action_widget'_<br>
  - ⚠️ **add_button** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'add_button'_<br>
  - ⚠️ **add_buttons** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'add_buttons'_<br>
  - ⚠️ **add_child** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'add_child'_<br>
  - ⚠️ **add_choice** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'add_choice'_<br>
  ...
  - ⚠️ **add_filter** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'add_filter'_<br>
  - ⚠️ **add_mnemonic** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'add_mnemonic'_<br>
  - ⚠️ **add_mnemonic_label** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'add_mnemonic_label'_<br>
  - ⚠️ **add_shortcut_folder** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'add_shortcut_folder'_<br>
  - ⚠️ **add_shortcut_folder_uri** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'add_shortcut_folder_uri'_<br>
...
<a name="begin-methods"></a>
  - ⚠️ **begin_move_drag** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'begin_move_drag'_<br>
  - ⚠️ **begin_resize_drag** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'begin_resize_drag'_<br>
- #### 🔹 bind Methods
...
- #### 🔹 do Methods
<a name="do-methods"></a>
  - ⚠️ **do_activate_default** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'do_activate_default'_<br>
  - ⚠️ **do_activate_focus** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'do_activate_focus'_<br>
  ...
  - ⚠️ **do_close** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'do_close'_<br>
  ...
  - ⚠️ **do_enable_debugging** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'do_enable_debugging'_<br>
  ...
  - ⚠️ **do_keys_changed** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'do_keys_changed'_<br>
  ...
  - ⚠️ **do_response** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'do_response'_<br>
  ...
  - ⚠️ **do_set_focus** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'do_set_focus'_<br>
...
<a name="fullscreen-methods"></a>
  - ⚠️ **fullscreen** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'fullscreen'_<br>
  - ⚠️ **fullscreen_on_monitor** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'fullscreen_on_monitor'_<br>
- #### 🔹 get Methods
<a name="get-methods"></a>
  - ⚠️ **get_accept_focus** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'get_accept_focus'_<br>
  - ⚠️ **get_accessible** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'get_accessible'_<br>
  - ⚠️ **get_action** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'get_action'_<br>
  - ⚠️ **get_action_area** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'get_action_area'_<br>
  ...
  - ⚠️ **get_application** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'get_application'_<br>
  - ⚠️ **get_attached_to** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'get_attached_to'_<br>
  ...
  - ⚠️ **get_choice** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'get_choice'_<br>
  ...
  - ⚠️ **get_content_area** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'get_content_area'_<br>
  - ⚠️ **get_create_folders** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'get_create_folders'_<br>
  - ⚠️ **get_css_name** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'get_css_name'_<br>
  - ⚠️ **get_current_folder** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'get_current_folder'_<br>
  - ⚠️ **get_current_folder_file** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'get_current_folder_file'_<br>
  - ⚠️ **get_current_folder_uri** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'get_current_folder_uri'_<br>
  - ⚠️ **get_current_name** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'get_current_name'_<br>
  - ⚠️ **get_data** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'get_data'_<br>
  - ⚠️ **get_decorated** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'get_decorated'_<br>
  - ⚠️ **get_default_direction** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'get_default_direction'_<br>
  - ⚠️ **get_default_icon_list** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'get_default_icon_list'_<br>
  - ⚠️ **get_default_icon_name** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'get_default_icon_name'_<br>
  - ⚠️ **get_default_size** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'get_default_size'_<br>
  - ⚠️ **get_default_style** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'get_default_style'_<br>
  - ⚠️ **get_default_widget** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'get_default_widget'_<br>
  - ⚠️ **get_deletable** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'get_deletable'_<br>
  - ⚠️ **get_destroy_with_parent** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'get_destroy_with_parent'_<br>
  ...
  - ⚠️ **get_do_overwrite_confirmation** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'get_do_overwrite_confirmation'_<br>
  ...
  - ⚠️ **get_extra_widget** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'get_extra_widget'_<br>
  - ⚠️ **get_file** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'get_file'_<br>
  - ⚠️ **get_filename** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'get_filename'_<br>
  - ⚠️ **get_filenames** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'get_filenames'_<br>
  - ⚠️ **get_files** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'get_files'_<br>
  - ⚠️ **get_filter** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'get_filter'_<br>
  - ⚠️ **get_focus** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'get_focus'_<br>
  ...
  - ⚠️ **get_focus_on_map** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'get_focus_on_map'_<br>
  - ⚠️ **get_focus_vadjustment** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'get_focus_vadjustment'_<br>
  - ⚠️ **get_focus_visible** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'get_focus_visible'_<br>
  ...
  - ⚠️ **get_gravity** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'get_gravity'_<br>
  - ⚠️ **get_group** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'get_group'_<br>
  - ⚠️ **get_halign** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'get_halign'_<br>
  - ⚠️ **get_has_resize_grip** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'get_has_resize_grip'_<br>
  ...
  - ⚠️ **get_header_bar** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'get_header_bar'_<br>
  ...
  - ⚠️ **get_hide_titlebar_when_maximized** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'get_hide_titlebar_when_maximized'_<br>
  - ⚠️ **get_icon** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'get_icon'_<br>
  - ⚠️ **get_icon_list** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'get_icon_list'_<br>
  ...
  - ⚠️ **get_local_only** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'get_local_only'_<br>
  ...
  - ⚠️ **get_mnemonic_modifier** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'get_mnemonic_modifier'_<br>
  - ⚠️ **get_mnemonics_visible** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'get_mnemonics_visible'_<br>
  - ⚠️ **get_modal** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'get_modal'_<br>
  ...
  - ⚠️ **get_preview_file** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'get_preview_file'_<br>
  - ⚠️ **get_preview_filename** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'get_preview_filename'_<br>
  - ⚠️ **get_preview_uri** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'get_preview_uri'_<br>
  - ⚠️ **get_preview_widget** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'get_preview_widget'_<br>
  - ⚠️ **get_preview_widget_active** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'get_preview_widget_active'_<br>
  ...
  - ⚠️ **get_resizable** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'get_resizable'_<br>
  - ⚠️ **get_resize_grip_area** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'get_resize_grip_area'_<br>
  - ⚠️ **get_resize_mode** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'get_resize_mode'_<br>
  - ⚠️ **get_response_for_widget** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'get_response_for_widget'_<br>
  - ⚠️ **get_role** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'get_role'_<br>
  ...
  - ⚠️ **get_select_multiple** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'get_select_multiple'_<br>
  ...
  - ⚠️ **get_show_hidden** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'get_show_hidden'_<br>
  ...
  - ⚠️ **get_skip_pager_hint** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'get_skip_pager_hint'_<br>
  - ⚠️ **get_skip_taskbar_hint** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'get_skip_taskbar_hint'_<br>
  ...
  - ⚠️ **get_titlebar** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'get_titlebar'_<br>
  ...
  - ⚠️ **get_transient_for** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'get_transient_for'_<br>
  - ⚠️ **get_type_hint** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'get_type_hint'_<br>
  - ⚠️ **get_urgency_hint** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'get_urgency_hint'_<br>
  - ⚠️ **get_uri** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'get_uri'_<br>
  - ⚠️ **get_uris** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'get_uris'_<br>
  - ⚠️ **get_use_preview_label** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'get_use_preview_label'_<br>
  ...
  - ⚠️ **get_widget_for_response** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'get_widget_for_response'_<br>
  - ⚠️ **get_window** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'get_window'_<br>
  - ⚠️ **get_window_type** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'get_window_type'_<br>
- #### 🔹 grab Methods
...
<a name="has-methods"></a>
  ...
  - ⚠️ **has_group** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'has_group'_<br>
  ...
  - ⚠️ **has_toplevel_focus** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'has_toplevel_focus'_<br>
...
- #### 🔹 is Methods
<a name="is-methods"></a>
  - ⚠️ **is_active** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'is_active'_<br>
  ...
  - ⚠️ **is_maximized** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'is_maximized'_<br>
...
<a name="list-methods"></a>
  ...
  - ⚠️ **list_filters** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'list_filters'_<br>
  ...
  - ⚠️ **list_shortcut_folder_uris** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'list_shortcut_folder_uris'_<br>
  - ⚠️ **list_shortcut_folders** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'list_shortcut_folders'_<br>
  - ⚠️ **list_style_properties** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'list_style_properties'_<br>
  - ⚠️ **list_toplevels** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'list_toplevels'_<br>
- #### 🔹 modify Methods
...
<a name="present-methods"></a>
  - ⚠️ **present** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'present'_<br>
  - ⚠️ **present_with_time** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'present_with_time'_<br>
- #### 🔹 propagate Methods
<a name="propagate-methods"></a>
  ...
  - ⚠️ **propagate_key_event** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'propagate_key_event'_<br>
- #### 🔹 queue Methods
...
<a name="remove-methods"></a>
  ...
  - ⚠️ **remove_accel_group** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'remove_accel_group'_<br>
  - ⚠️ **remove_accelerator** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'remove_accelerator'_<br>
  - ⚠️ **remove_choice** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'remove_choice'_<br>
  - ⚠️ **remove_filter** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'remove_filter'_<br>
  - ⚠️ **remove_mnemonic** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'remove_mnemonic'_<br>
  - ⚠️ **remove_mnemonic_label** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'remove_mnemonic_label'_<br>
  - ⚠️ **remove_shortcut_folder** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'remove_shortcut_folder'_<br>
  - ⚠️ **remove_shortcut_folder_uri** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'remove_shortcut_folder_uri'_<br>
...
<a name="resize-methods"></a>
  ...
  - ⚠️ **resize_grip_is_visible** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'resize_grip_is_visible'_<br>
  - ⚠️ **resize_to_geometry** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'resize_to_geometry'_<br>
- #### 🔹 run Methods
...
<a name="select-methods"></a>
  - ⚠️ **select_all** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'select_all'_<br>
  - ⚠️ **select_file** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'select_file'_<br>
  - ⚠️ **select_filename** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'select_filename'_<br>
  - ⚠️ **select_uri** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'select_uri'_<br>
- #### 🔹 send Methods
...
<a name="set-methods"></a>
  ...
  - ⚠️ **set_accept_focus** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'set_accept_focus'_<br>
  ...
  - ⚠️ **set_action** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'set_action'_<br>
  - ⚠️ **set_allocation** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'set_allocation'_<br>
  - ⚠️ **set_alternative_button_order_from_array** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'set_alternative_button_order_from_array'_<br>
  - ⚠️ **set_app_paintable** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'set_app_paintable'_<br>
  - ⚠️ **set_application** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'set_application'_<br>
  - ⚠️ **set_attached_to** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'set_attached_to'_<br>
  - ⚠️ **set_auto_startup_notification** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'set_auto_startup_notification'_<br>
  ...
  - ⚠️ **set_choice** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'set_choice'_<br>
  ...
  - ⚠️ **set_create_folders** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'set_create_folders'_<br>
  - ⚠️ **set_css_name** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'set_css_name'_<br>
  - ⚠️ **set_current_folder** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'set_current_folder'_<br>
  - ⚠️ **set_current_folder_file** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'set_current_folder_file'_<br>
  - ⚠️ **set_current_folder_uri** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'set_current_folder_uri'_<br>
  - ⚠️ **set_current_name** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'set_current_name'_<br>
  - ⚠️ **set_data** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'set_data'_<br>
  - ⚠️ **set_decorated** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'set_decorated'_<br>
  - ⚠️ **set_default** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'set_default'_<br>
  - ⚠️ **set_default_direction** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'set_default_direction'_<br>
  - ⚠️ **set_default_geometry** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'set_default_geometry'_<br>
  - ⚠️ **set_default_icon** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'set_default_icon'_<br>
  - ⚠️ **set_default_icon_from_file** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'set_default_icon_from_file'_<br>
  - ⚠️ **set_default_icon_list** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'set_default_icon_list'_<br>
  - ⚠️ **set_default_icon_name** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'set_default_icon_name'_<br>
  - ⚠️ **set_default_response** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'set_default_response'_<br>
  - ⚠️ **set_default_size** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'set_default_size'_<br>
  - ⚠️ **set_deletable** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'set_deletable'_<br>
  - ⚠️ **set_destroy_with_parent** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'set_destroy_with_parent'_<br>
  ...
  - ⚠️ **set_do_overwrite_confirmation** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'set_do_overwrite_confirmation'_<br>
  ...
  - ⚠️ **set_extra_widget** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'set_extra_widget'_<br>
  - ⚠️ **set_file** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'set_file'_<br>
  - ⚠️ **set_filename** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'set_filename'_<br>
  - ⚠️ **set_filter** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'set_filter'_<br>
  - ⚠️ **set_focus** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'set_focus'_<br>
  ...
  - ⚠️ **set_focus_on_map** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'set_focus_on_map'_<br>
  - ⚠️ **set_focus_vadjustment** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'set_focus_vadjustment'_<br>
  - ⚠️ **set_focus_visible** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'set_focus_visible'_<br>
  ...
  - ⚠️ **set_geometry_hints** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'set_geometry_hints'_<br>
  - ⚠️ **set_gravity** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'set_gravity'_<br>
  - ⚠️ **set_halign** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'set_halign'_<br>
  - ⚠️ **set_has_resize_grip** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'set_has_resize_grip'_<br>
  - ⚠️ **set_has_tooltip** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'set_has_tooltip'_<br>
  - ⚠️ **set_has_user_ref_count** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'set_has_user_ref_count'_<br>
  ...
  - ⚠️ **set_hide_titlebar_when_maximized** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'set_hide_titlebar_when_maximized'_<br>
  - ⚠️ **set_icon** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'set_icon'_<br>
  - ⚠️ **set_icon_from_file** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'set_icon_from_file'_<br>
  - ⚠️ **set_icon_list** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'set_icon_list'_<br>
  - ⚠️ **set_icon_name** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'set_icon_name'_<br>
  - ⚠️ **set_interactive_debugging** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'set_interactive_debugging'_<br>
  - ⚠️ **set_keep_above** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'set_keep_above'_<br>
  - ⚠️ **set_keep_below** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'set_keep_below'_<br>
  - ⚠️ **set_local_only** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'set_local_only'_<br>
  ...
  - ⚠️ **set_mnemonic_modifier** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'set_mnemonic_modifier'_<br>
  - ⚠️ **set_mnemonics_visible** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'set_mnemonics_visible'_<br>
  - ⚠️ **set_modal** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'set_modal'_<br>
  ...
  - ⚠️ **set_preview_widget** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'set_preview_widget'_<br>
  - ⚠️ **set_preview_widget_active** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'set_preview_widget_active'_<br>
  ...
  - ⚠️ **set_resizable** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'set_resizable'_<br>
  - ⚠️ **set_resize_mode** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'set_resize_mode'_<br>
  - ⚠️ **set_response_sensitive** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'set_response_sensitive'_<br>
  - ⚠️ **set_role** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'set_role'_<br>
  - ⚠️ **set_screen** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'set_screen'_<br>
  - ⚠️ **set_select_multiple** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'set_select_multiple'_<br>
  - ⚠️ **set_sensitive** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'set_sensitive'_<br>
  - ⚠️ **set_show_hidden** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'set_show_hidden'_<br>
  - ⚠️ **set_size_request** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'set_size_request'_<br>
  - ⚠️ **set_skip_pager_hint** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'set_skip_pager_hint'_<br>
  - ⚠️ **set_skip_taskbar_hint** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'set_skip_taskbar_hint'_<br>
  - ⚠️ **set_startup_id** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'set_startup_id'_<br>
  ...
  - ⚠️ **set_titlebar** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'set_titlebar'_<br>
  ...
  - ⚠️ **set_transient_for** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'set_transient_for'_<br>
  - ⚠️ **set_type_hint** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'set_type_hint'_<br>
  - ⚠️ **set_urgency_hint** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'set_urgency_hint'_<br>
  - ⚠️ **set_uri** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'set_uri'_<br>
  - ⚠️ **set_use_preview_label** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'set_use_preview_label'_<br>
  ...
  - ⚠️ **set_wmclass** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'set_wmclass'_<br>
- #### 🔹 show Methods
...
- #### 🔹 unselect Methods
<a name="unselect-methods"></a>
  - ⚠️ **unselect_all** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'unselect_all'_<br>
  - ⚠️ **unselect_file** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'unselect_file'_<br>
  - ⚠️ **unselect_filename** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'unselect_filename'_<br>
  - ⚠️ **unselect_uri** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'unselect_uri'_<br>
- #### 🔹 unset Methods
...
<a name="ungrouped-methods"></a>
  ...
  - ⚠️ **close** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'close'_<br>
  ...
  - ⚠️ **deiconify** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'deiconify'_<br>
  ...
  - ⚠️ **iconify** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'iconify'_<br>
  ...
  - ⚠️ **maximize** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'maximize'_<br>
  - ⚠️ **mnemonic_activate** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'mnemonic_activate'_<br>
  - ⚠️ **move** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'move'_<br>
  ...
  - ⚠️ **parse_geometry** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'parse_geometry'_<br>
  ...
  - ⚠️ **reshow_with_initial_size** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'reshow_with_initial_size'_<br>
  - ⚠️ **response** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'response'_<br>
  - ⚠️ **shape_combine_region** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'shape_combine_region'_<br>
  - ⚠️ **stick** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'stick'_<br>
  ...
  - ⚠️ **unfullscreen** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'unfullscreen'_<br>
  - ⚠️ **unmap** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'unmap'_<br>
  - ⚠️ **unmaximize** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'unmaximize'_<br>
  ...
  - ⚠️ **unstick** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'unstick'_<br>
...
<a name="ungrouped-methods"></a>
  ...
  - ⚠️ **_init** _Unable to extract signature — type object 'GObjectMeta' has no attribute '_init'_<br>

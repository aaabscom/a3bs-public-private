...
<a name="get-methods"></a>
  ...
  - ⚠️ **get_active_file** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'get_active_file'_<br>
  ...
  - ⚠️ **get_popup_accessible** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'get_popup_accessible'_<br>
...
<a name="set-methods"></a>
  ...
  - ⚠️ **set_active_file** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'set_active_file'_<br>
  ...
  - ⚠️ **set_active_profile** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'set_active_profile'_<br>

...
⚠️ **do_channel_changed** _Unavailable_ †<br>
...
⚠️ **do_model_visible_changed** _Unavailable_ †<br>
...
⚠️ **do_set_channel** _Unavailable_ †<br>
⚠️ **do_set_child_property** _Unavailable_ †<br>
⚠️ **do_set_color** _Unavailable_ †<br>
⚠️ **do_set_config** _Unavailable_ †<br>
⚠️ **do_set_focus_child** _Unavailable_ †<br>
⚠️ **do_set_format** _Unavailable_ †<br>
⚠️ **do_set_model_visible** _Unavailable_ †<br>
⚠️ **do_set_show_alpha** _Unavailable_ †<br>
⚠️ **do_set_simulation** _Unavailable_ †<br>
⚠️ **do_set_toggles_sensitive** _Unavailable_ †<br>
⚠️ **do_set_toggles_visible** _Unavailable_ †<br>
⚠️ **do_show** _Unavailable_ †<br>
⚠️ **do_show_all** _Unavailable_ †<br>
⚠️ **do_show_help** _Unavailable_ †<br>
⚠️ **do_simulation** _Unavailable_ †<br>
...
⚠️ **get_channel** _Unavailable_ †<br>
...
⚠️ **get_current_selector** _Unavailable_ †<br>
...
⚠️ **get_model_visible** _Unavailable_ †<br>
...
⚠️ **get_notebook** _Unavailable_ †<br>
...
⚠️ **get_selectors** _Unavailable_ †<br>
⚠️ **get_sensitive** _Unavailable_ †<br>
⚠️ **get_settings** _Unavailable_ †<br>
⚠️ **get_show_alpha** _Unavailable_ †<br>
⚠️ **get_simulation** _Unavailable_ †<br>
...
⚠️ **get_toggles_sensitive** _Unavailable_ †<br>
⚠️ **get_toggles_visible** _Unavailable_ †<br>
...
⚠️ **set_has_page** _Unavailable_ †<br>
...
⚠️ **set_model_visible** _Unavailable_ †<br>
...
⚠️ **set_show_alpha** _Unavailable_ †<br>
⚠️ **set_simulation** _Unavailable_ †<br>
...
⚠️ **set_toggles_sensitive** _Unavailable_ †<br>
⚠️ **set_toggles_visible** _Unavailable_ †<br>
...
⚠️ **enable_simulation** _Unavailable_ †<br>

...
<a name="get-methods"></a>
  ...
  - ⚠️ **get_current_selector** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'get_current_selector'_<br>
  ...
  - ⚠️ **get_notebook** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'get_notebook'_<br>
  ...
  - ⚠️ **get_selectors** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'get_selectors'_<br>
...
<a name="set-methods"></a>
  ...
  - ⚠️ **set_has_page** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'set_has_page'_<br>

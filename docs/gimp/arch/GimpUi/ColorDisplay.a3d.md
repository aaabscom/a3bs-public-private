...
<a name="configure-methods"></a>
  ...
  - ⚠️ **configure_reset** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'configure_reset'_<br>
- #### 🔹 connect Methods
...
<a name="do-methods"></a>
  ...
  - ⚠️ **do_configure** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'do_configure'_<br>
  - ⚠️ **do_convert_buffer** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'do_convert_buffer'_<br>
- #### 🔹 emit Methods
...
<a name="get-methods"></a>
  - ⚠️ **get_config** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'get_config'_<br>
  - ⚠️ **get_data** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'get_data'_<br>
  - ⚠️ **get_enabled** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'get_enabled'_<br>
  - ⚠️ **get_managed** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'get_managed'_<br>
...
<a name="set-methods"></a>
  ...
  - ⚠️ **set_enabled** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'set_enabled'_<br>
...
<a name="ungrouped-methods"></a>
  ...
  - ⚠️ **changed** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'changed'_<br>
  - ⚠️ **clone** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'clone'_<br>
  - ⚠️ **compat_control** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'compat_control'_<br>
  - ⚠️ **convert_buffer** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'convert_buffer'_<br>
  ...
  - ⚠️ **load_state** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'load_state'_<br>
  ...
  - ⚠️ **save_state** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'save_state'_<br>
...
<a name="properties-"></a>
  ...
  - **color  -managed**: `GimpColorManaged` (read/write)
<br>
#### 📣 Signals
<a name="signals-"></a>
<br>- None found

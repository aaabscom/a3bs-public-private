...
<a name="zoom-methods"></a>
  - ⚠️ **zoom** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'zoom'_<br>
  - ⚠️ **zoom_step** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'zoom_step'_<br>
- #### 🔹 ungrouped Methods

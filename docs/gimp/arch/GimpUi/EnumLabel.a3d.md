...
- #### 🔹 do Methods
<a name="do-methods"></a>
⚠️ **do_activate_link** _Unavailable_ †<br>
...
⚠️ **get_current_uri** _Unavailable_ †<br>
...
⚠️ **get_ellipsize** _Unavailable_ †<br>
...
⚠️ **get_justify** _Unavailable_ †<br>
⚠️ **get_label** _Unavailable_ †<br>
⚠️ **get_layout** _Unavailable_ †<br>
⚠️ **get_layout_offsets** _Unavailable_ †<br>
⚠️ **get_line_wrap** _Unavailable_ †<br>
⚠️ **get_line_wrap_mode** _Unavailable_ †<br>
⚠️ **get_lines** _Unavailable_ †<br>
...
⚠️ **get_mnemonic_widget** _Unavailable_ †<br>
...
⚠️ **get_padding** _Unavailable_ †<br>
...
⚠️ **get_track_visited_links** _Unavailable_ †<br>
⚠️ **get_use_markup** _Unavailable_ †<br>
...
⚠️ **get_xalign** _Unavailable_ †<br>
⚠️ **get_yalign** _Unavailable_ †<br>
- #### 🔹 grab Methods
...
⚠️ **set_ellipsize** _Unavailable_ †<br>
...
⚠️ **set_justify** _Unavailable_ †<br>
⚠️ **set_label** _Unavailable_ †<br>
⚠️ **set_line_wrap** _Unavailable_ †<br>
⚠️ **set_line_wrap_mode** _Unavailable_ †<br>
⚠️ **set_lines** _Unavailable_ †<br>
...
⚠️ **set_selectable** _Unavailable_ †<br>
⚠️ **set_sensitive** _Unavailable_ †<br>
⚠️ **set_single_line_mode** _Unavailable_ †<br>
...
⚠️ **set_text_with_mnemonic** _Unavailable_ †<br>
⚠️ **set_tooltip_markup** _Unavailable_ †<br>
⚠️ **set_tooltip_text** _Unavailable_ †<br>
⚠️ **set_tooltip_window** _Unavailable_ †<br>
⚠️ **set_track_visited_links** _Unavailable_ †<br>
⚠️ **set_use_markup** _Unavailable_ †<br>
...
⚠️ **set_xalign** _Unavailable_ †<br>
⚠️ **set_yalign** _Unavailable_ †<br>
- #### 🔹 show Methods

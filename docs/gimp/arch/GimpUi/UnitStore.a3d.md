...
---
title: "UnitStore Class Documentation"
date: 2025-06-27
layout: default
---

## Table of Contents
- [🔧 Class:UnitStore](#class-unitstore)
...
<a name="get-methods"></a>
  ...
  - ⚠️ **get_has_percent** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'get_has_percent'_<br>
  - ⚠️ **get_has_pixels** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'get_has_pixels'_<br>
  ...
  - ⚠️ **get_nth_value** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'get_nth_value'_<br>
...
<a name="set-methods"></a>
  ...
  - ⚠️ **set_has_percent** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'set_has_percent'_<br>
  - ⚠️ **set_has_pixels** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'set_has_pixels'_<br>
  - ⚠️ **set_pixel_value** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'set_pixel_value'_<br>
...
#### 🏷️ Properties
<a name="properties-"></a>
  - **num  -values**: `gint` (read/write)
  - **has  -pixels**: `gboolean` (read/write)
  - **has  -percent**: `gboolean` (read/write)
  - **short  -format**: `gchararray` (read/write)
  - **long  -format**: `gchararray` (read/write)
<br>
#### 📣 Signals
<a name="signals-"></a>
<br>- None found

...
---
title: "PreviewArea Class Documentation"
date: 2025-06-27
layout: default
---

## Table of Contents
- [🔧 Class:PreviewArea](#class-previewarea)
...
<a name="set-methods"></a>
  ...
  - ⚠️ **set_max_size** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'set_max_size'_<br>
...
<a name="ungrouped-methods"></a>
  ...
  - ⚠️ **blend** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'blend'_<br>
  ...
  - ⚠️ **mask** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'mask'_<br>
  - ⚠️ **menu_popup** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'menu_popup'_<br>
...
<a name="properties-"></a>
  ...
  - **check  -custom  -color1**: `GeglColor` (read/write)
  - **check  -custom  -color2**: `GeglColor` (read/write)
<br>
#### 📣 Signals
<a name="signals-"></a>
<br>- None found

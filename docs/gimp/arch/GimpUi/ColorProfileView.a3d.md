...
⚠️ **add_child_at_anchor** _Unavailable_ †
⚠️ **add_child_in_window** _Unavailable_ †
...
⚠️ **backward_display_line** _Unavailable_ †
⚠️ **backward_display_line_start** _Unavailable_ †
- #### 🔹 bind Methods
...
⚠️ **do_draw_layer** _Unavailable_ †
⚠️ **do_enter_notify_event** _Unavailable_ †
⚠️ **do_event** _Unavailable_ †
⚠️ **do_extend_selection** _Unavailable_ †
...
⚠️ **forward_display_line** _Unavailable_ †
⚠️ **forward_display_line_end** _Unavailable_ †
- #### 🔹 freeze Methods
...
⚠️ **get_accepts_tab** _Unavailable_ †
...
⚠️ **get_border** _Unavailable_ †
⚠️ **get_border_width** _Unavailable_ †
⚠️ **get_border_window_size** _Unavailable_ †
⚠️ **get_bottom_margin** _Unavailable_ †
...
⚠️ **get_cursor_locations** _Unavailable_ †
⚠️ **get_cursor_visible** _Unavailable_ †
⚠️ **get_data** _Unavailable_ †
⚠️ **get_default_attributes** _Unavailable_ †
...
⚠️ **get_hadjustment** _Unavailable_ †
...
⚠️ **get_hscroll_policy** _Unavailable_ †
⚠️ **get_indent** _Unavailable_ †
⚠️ **get_input_hints** _Unavailable_ †
⚠️ **get_input_purpose** _Unavailable_ †
⚠️ **get_internal_child** _Unavailable_ †
⚠️ **get_iter_at_location** _Unavailable_ †
⚠️ **get_iter_at_position** _Unavailable_ †
⚠️ **get_iter_location** _Unavailable_ †
⚠️ **get_justification** _Unavailable_ †
⚠️ **get_left_margin** _Unavailable_ †
⚠️ **get_line_at_y** _Unavailable_ †
⚠️ **get_line_yrange** _Unavailable_ †
...
⚠️ **get_pixels_above_lines** _Unavailable_ †
⚠️ **get_pixels_below_lines** _Unavailable_ †
⚠️ **get_pixels_inside_wrap** _Unavailable_ †
...
⚠️ **get_right_margin** _Unavailable_ †
...
⚠️ **get_top_margin** _Unavailable_ †
⚠️ **get_toplevel** _Unavailable_ †
⚠️ **get_vadjustment** _Unavailable_ †
...
⚠️ **get_visible_rect** _Unavailable_ †
⚠️ **get_visual** _Unavailable_ †
⚠️ **get_vscroll_policy** _Unavailable_ †
⚠️ **get_window** _Unavailable_ †
⚠️ **get_window_type** _Unavailable_ †
⚠️ **get_wrap_mode** _Unavailable_ †
- #### 🔹 grab Methods
...
⚠️ **move_child** _Unavailable_ †
⚠️ **move_mark_onscreen** _Unavailable_ †
⚠️ **move_visually** _Unavailable_ †
- #### 🔹 new Methods
...
⚠️ **reset_cursor_blink** _Unavailable_ †
⚠️ **reset_im_context** _Unavailable_ †
⚠️ **reset_rc_styles** _Unavailable_ †
⚠️ **reset_style** _Unavailable_ †
- #### 🔹 scroll Methods
<a name="scroll-methods"></a>
⚠️ **scroll_mark_onscreen** _Unavailable_ †
⚠️ **scroll_to_iter** _Unavailable_ †
⚠️ **scroll_to_mark** _Unavailable_ †
- #### 🔹 send Methods
...
⚠️ **set_accepts_tab** _Unavailable_ †
...
⚠️ **set_border_window_size** _Unavailable_ †
⚠️ **set_bottom_margin** _Unavailable_ †
...
⚠️ **set_cursor_visible** _Unavailable_ †
...
⚠️ **set_hadjustment** _Unavailable_ †
...
⚠️ **set_hscroll_policy** _Unavailable_ †
⚠️ **set_indent** _Unavailable_ †
⚠️ **set_input_hints** _Unavailable_ †
⚠️ **set_input_purpose** _Unavailable_ †
⚠️ **set_justification** _Unavailable_ †
⚠️ **set_left_margin** _Unavailable_ †
...
⚠️ **set_monospace** _Unavailable_ †
⚠️ **set_name** _Unavailable_ †
⚠️ **set_no_show_all** _Unavailable_ †
⚠️ **set_opacity** _Unavailable_ †
⚠️ **set_overwrite** _Unavailable_ †
⚠️ **set_parent** _Unavailable_ †
⚠️ **set_parent_window** _Unavailable_ †
⚠️ **set_pixels_above_lines** _Unavailable_ †
⚠️ **set_pixels_below_lines** _Unavailable_ †
⚠️ **set_pixels_inside_wrap** _Unavailable_ †
⚠️ **set_profile** _Unavailable_ †
...
⚠️ **set_right_margin** _Unavailable_ †
...
⚠️ **set_top_margin** _Unavailable_ †
⚠️ **set_vadjustment** _Unavailable_ †
...
⚠️ **set_vscroll_policy** _Unavailable_ †
⚠️ **set_window** _Unavailable_ †
⚠️ **set_wrap_mode** _Unavailable_ †
- #### 🔹 show Methods
...
⚠️ **buffer_to_window_coords** _Unavailable_ †
...
⚠️ **place_cursor_onscreen** _Unavailable_ †
...
⚠️ **starts_display_line** _Unavailable_ †

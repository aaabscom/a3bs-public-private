...
⚠️ **add_child_at_anchor** _Unavailable_ †<br>
⚠️ **add_child_in_window** _Unavailable_ †<br>
...
⚠️ **backward_display_line** _Unavailable_ †<br>
⚠️ **backward_display_line_start** _Unavailable_ †<br>
- #### 🔹 bind Methods
...
⚠️ **do_draw_layer** _Unavailable_ †<br>
⚠️ **do_enter_notify_event** _Unavailable_ †<br>
⚠️ **do_event** _Unavailable_ †<br>
⚠️ **do_extend_selection** _Unavailable_ †<br>
...
⚠️ **do_set_anchor** _Unavailable_ †<br>
...
⚠️ **forward_display_line** _Unavailable_ †<br>
⚠️ **forward_display_line_end** _Unavailable_ †<br>
- #### 🔹 freeze Methods
...
⚠️ **get_accepts_tab** _Unavailable_ †<br>
...
⚠️ **get_border** _Unavailable_ †<br>
⚠️ **get_border_width** _Unavailable_ †<br>
⚠️ **get_border_window_size** _Unavailable_ †<br>
⚠️ **get_bottom_margin** _Unavailable_ †<br>
...
⚠️ **get_cursor_locations** _Unavailable_ †<br>
⚠️ **get_cursor_visible** _Unavailable_ †<br>
⚠️ **get_data** _Unavailable_ †<br>
⚠️ **get_default_attributes** _Unavailable_ †<br>
...
⚠️ **get_hadjustment** _Unavailable_ †<br>
...
⚠️ **get_hscroll_policy** _Unavailable_ †<br>
...
⚠️ **get_iter_at_location** _Unavailable_ †<br>
⚠️ **get_iter_at_position** _Unavailable_ †<br>
⚠️ **get_iter_location** _Unavailable_ †<br>
⚠️ **get_justification** _Unavailable_ †<br>
⚠️ **get_left_margin** _Unavailable_ †<br>
⚠️ **get_line_at_y** _Unavailable_ †<br>
⚠️ **get_line_yrange** _Unavailable_ †<br>
...
⚠️ **get_pixels_above_lines** _Unavailable_ †<br>
⚠️ **get_pixels_below_lines** _Unavailable_ †<br>
⚠️ **get_pixels_inside_wrap** _Unavailable_ †<br>
...
⚠️ **get_right_margin** _Unavailable_ †<br>
...
⚠️ **get_top_margin** _Unavailable_ †<br>
⚠️ **get_toplevel** _Unavailable_ †<br>
⚠️ **get_vadjustment** _Unavailable_ †<br>
...
⚠️ **get_visible_rect** _Unavailable_ †<br>
⚠️ **get_visual** _Unavailable_ †<br>
⚠️ **get_vscroll_policy** _Unavailable_ †<br>
⚠️ **get_window** _Unavailable_ †<br>
⚠️ **get_window_type** _Unavailable_ †<br>
⚠️ **get_wrap_mode** _Unavailable_ †<br>
- #### 🔹 grab Methods
...
⚠️ **move_child** _Unavailable_ †<br>
⚠️ **move_mark_onscreen** _Unavailable_ †<br>
⚠️ **move_visually** _Unavailable_ †<br>
- #### 🔹 new Methods
...
⚠️ **reset_cursor_blink** _Unavailable_ †<br>
...
⚠️ **scroll_mark_onscreen** _Unavailable_ †<br>
⚠️ **scroll_to_iter** _Unavailable_ †<br>
⚠️ **scroll_to_mark** _Unavailable_ †<br>
- #### 🔹 send Methods
...
⚠️ **set_accepts_tab** _Unavailable_ †<br>
...
⚠️ **set_border_window_size** _Unavailable_ †<br>
⚠️ **set_bottom_margin** _Unavailable_ †<br>
...
⚠️ **set_cursor_visible** _Unavailable_ †<br>
...
⚠️ **set_hadjustment** _Unavailable_ †<br>
...
⚠️ **set_hscroll_policy** _Unavailable_ †<br>
...
⚠️ **set_left_margin** _Unavailable_ †<br>
...
⚠️ **set_monospace** _Unavailable_ †<br>
⚠️ **set_name** _Unavailable_ †<br>
⚠️ **set_no_show_all** _Unavailable_ †<br>
⚠️ **set_opacity** _Unavailable_ †<br>
⚠️ **set_overwrite** _Unavailable_ †<br>
⚠️ **set_parent** _Unavailable_ †<br>
⚠️ **set_parent_window** _Unavailable_ †<br>
⚠️ **set_pixels_above_lines** _Unavailable_ †<br>
⚠️ **set_pixels_below_lines** _Unavailable_ †<br>
⚠️ **set_pixels_inside_wrap** _Unavailable_ †<br>
⚠️ **set_profile** _Unavailable_ †<br>
...
⚠️ **set_right_margin** _Unavailable_ †<br>
...
⚠️ **set_top_margin** _Unavailable_ †<br>
⚠️ **set_vadjustment** _Unavailable_ †<br>
...
⚠️ **set_vscroll_policy** _Unavailable_ †<br>
⚠️ **set_window** _Unavailable_ †<br>
⚠️ **set_wrap_mode** _Unavailable_ †<br>
- #### 🔹 show Methods
...
⚠️ **buffer_to_window_coords** _Unavailable_ †<br>
...
⚠️ **place_cursor_onscreen** _Unavailable_ †<br>
...
⚠️ **starts_display_line** _Unavailable_ †<br>
...
⚠️ **window_to_buffer_coords** _Unavailable_ †<br>
### 🔒 Private Methods

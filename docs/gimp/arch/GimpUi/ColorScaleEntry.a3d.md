...
<a name="get-methods"></a>
  ...
  - ⚠️ **get_logarithmic** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'get_logarithmic'_<br>
  ...
  - ⚠️ **get_spin_button** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'get_spin_button'_<br>
...
<a name="set-methods"></a>
  ...
  - ⚠️ **set_logarithmic** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'set_logarithmic'_<br>

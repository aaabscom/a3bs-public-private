...
---
title: "PathEditor Class Documentation"
date: 2025-06-27
layout: default
---
...
<a name="get-methods"></a>
  ...
  - ⚠️ **get_dir_writable** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'get_dir_writable'_<br>
  ...
  - ⚠️ **get_writable_path** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'get_writable_path'_<br>
- #### 🔹 grab Methods
...
<a name="set-methods"></a>
  ...
  - ⚠️ **set_dir_writable** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'set_dir_writable'_<br>
  ...
  - ⚠️ **set_path** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'set_path'_<br>
  ...
  - ⚠️ **set_writable_path** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'set_writable_path'_<br>
- #### 🔹 show Methods

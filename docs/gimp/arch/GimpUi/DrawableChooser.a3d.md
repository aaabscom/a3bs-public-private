...
---
title: "DrawableChooser Class Documentation"
date: 2025-06-27
layout: default
---

## Table of Contents
- [🔧 Class:DrawableChooser](#class-drawablechooser)
...
<a name="set-methods"></a>
  ...
  - ⚠️ **set_drawable** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'set_drawable'_<br>
...
<a name="properties-"></a>
  ...
  - **drawable  -type**: `GType` (read/write)
<br>
#### 📣 Signals
<a name="signals-"></a>
<br>- None found

...
⚠️ **do_clicked** _Unavailable_ †<br>
⚠️ **do_color_changed** _Unavailable_ †<br>
...
⚠️ **do_get_action_type** _Unavailable_ †<br>
...
⚠️ **do_released** _Unavailable_ †<br>
...
⚠️ **do_set_related_action** _Unavailable_ †<br>
...
⚠️ **get_action_name** _Unavailable_ †<br>
⚠️ **get_action_target_value** _Unavailable_ †<br>
...
⚠️ **get_always_show_image** _Unavailable_ †<br>
...
⚠️ **get_event_window** _Unavailable_ †<br>
...
⚠️ **get_image_position** _Unavailable_ †<br>
...
⚠️ **get_related_action** _Unavailable_ †<br>
⚠️ **get_relief** _Unavailable_ †<br>
...
⚠️ **get_update** _Unavailable_ †<br>
⚠️ **get_use_action_appearance** _Unavailable_ †<br>
⚠️ **get_use_stock** _Unavailable_ †<br>
⚠️ **get_use_underline** _Unavailable_ †<br>
...
⚠️ **new_from_icon_name** _Unavailable_ †<br>
⚠️ **new_from_stock** _Unavailable_ †<br>
⚠️ **new_with_label** _Unavailable_ †<br>
⚠️ **new_with_mnemonic** _Unavailable_ †<br>
- #### 🔹 notify Methods
...
⚠️ **set_action_name** _Unavailable_ †<br>
⚠️ **set_action_target_value** _Unavailable_ †<br>
⚠️ **set_alignment** _Unavailable_ †<br>
⚠️ **set_allocation** _Unavailable_ †<br>
⚠️ **set_always_show_image** _Unavailable_ †<br>
...
⚠️ **set_color_config** _Unavailable_ †<br>
...
⚠️ **set_detailed_action_name** _Unavailable_ †<br>
...
⚠️ **set_image** _Unavailable_ †<br>
⚠️ **set_image_position** _Unavailable_ †<br>
...
⚠️ **set_related_action** _Unavailable_ †<br>
⚠️ **set_relief** _Unavailable_ †<br>
...
⚠️ **set_type** _Unavailable_ †<br>
⚠️ **set_update** _Unavailable_ †<br>
⚠️ **set_use_action_appearance** _Unavailable_ †<br>
⚠️ **set_use_stock** _Unavailable_ †<br>
⚠️ **set_use_underline** _Unavailable_ †<br>
...
⚠️ **enter** _Unavailable_ †<br>
⚠️ **error_bell** _Unavailable_ †<br>
⚠️ **event** _Unavailable_ †<br>
⚠️ **extended_clicked** _Unavailable_ †<br>
...
⚠️ **sync_action_properties** _Unavailable_ †<br>

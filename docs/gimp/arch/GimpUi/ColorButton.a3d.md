...
---
title: "ColorButton Class Documentation"
date: 2025-06-27
layout: default
---
...
<a name="do-methods"></a>
  ...
  - ⚠️ **do_clicked** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'do_clicked'_<br>
  ...
  - ⚠️ **do_enter** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'do_enter'_<br>
  ...
  - ⚠️ **do_extended_clicked** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'do_extended_clicked'_<br>
  ...
  - ⚠️ **do_get_action_type** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'do_get_action_type'_<br>
  ...
  - ⚠️ **do_leave** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'do_leave'_<br>
  ...
  - ⚠️ **do_pressed** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'do_pressed'_<br>
  ...
  - ⚠️ **do_released** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'do_released'_<br>
  ...
  - ⚠️ **do_set_related_action** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'do_set_related_action'_<br>
...
<a name="get-methods"></a>
  ...
  - ⚠️ **get_action_name** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'get_action_name'_<br>
  - ⚠️ **get_action_target_value** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'get_action_target_value'_<br>
  ...
  - ⚠️ **get_always_show_image** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'get_always_show_image'_<br>
  ...
  - ⚠️ **get_event_window** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'get_event_window'_<br>
  ...
  - ⚠️ **get_image_position** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'get_image_position'_<br>
  ...
  - ⚠️ **get_related_action** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'get_related_action'_<br>
  - ⚠️ **get_relief** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'get_relief'_<br>
  ...
  - ⚠️ **get_use_action_appearance** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'get_use_action_appearance'_<br>
  - ⚠️ **get_use_stock** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'get_use_stock'_<br>
  - ⚠️ **get_use_underline** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'get_use_underline'_<br>
...
<a name="new-methods"></a>
  ...
  - ⚠️ **new_from_icon_name** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'new_from_icon_name'_<br>
  - ⚠️ **new_from_stock** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'new_from_stock'_<br>
  - ⚠️ **new_with_label** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'new_with_label'_<br>
  - ⚠️ **new_with_mnemonic** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'new_with_mnemonic'_<br>
- #### 🔹 notify Methods
...
<a name="set-methods"></a>
  ...
  - ⚠️ **set_action_name** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'set_action_name'_<br>
  - ⚠️ **set_action_target_value** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'set_action_target_value'_<br>
  ...
  - ⚠️ **set_always_show_image** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'set_always_show_image'_<br>
  ...
  - ⚠️ **set_color_config** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'set_color_config'_<br>
  ...
  - ⚠️ **set_detailed_action_name** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'set_detailed_action_name'_<br>
  ...
  - ⚠️ **set_image** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'set_image'_<br>
  - ⚠️ **set_image_position** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'set_image_position'_<br>
  ...
  - ⚠️ **set_related_action** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'set_related_action'_<br>
  - ⚠️ **set_relief** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'set_relief'_<br>
  ...
  - ⚠️ **set_type** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'set_type'_<br>
  - ⚠️ **set_update** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'set_update'_<br>
  - ⚠️ **set_use_action_appearance** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'set_use_action_appearance'_<br>
  - ⚠️ **set_use_stock** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'set_use_stock'_<br>
  - ⚠️ **set_use_underline** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'set_use_underline'_<br>
...
<a name="ungrouped-methods"></a>
  ...
  - ⚠️ **clicked** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'clicked'_<br>
  ...
  - ⚠️ **enter** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'enter'_<br>
  ...
  - ⚠️ **extended_clicked** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'extended_clicked'_<br>
  ...
  - ⚠️ **leave** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'leave'_<br>
  ...
  - ⚠️ **pressed** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'pressed'_<br>
  ...
  - ⚠️ **released** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'released'_<br>
  ...
  - ⚠️ **sync_action_properties** _Unable to extract signature — type object 'GObjectMeta' has no attribute 'sync_action_properties'_<br>
...
#### 🏷️ Properties
<a name="properties-"></a>
  - **action  -name**: `gchararray` (read/write)
  ...
  - **type**: `GimpColorAreaType` (read/write)
  - **continuous  -update**: `gboolean` (read/write)
  - **area  -width**: `gint` (write)
  - **area  -height**: `gint` (write)
  - **color  -config**: `GimpColorConfig` (read/write)
<br>
#### 📣 Signals
<a name="signals-"></a>
<br>- None found
